...
FreeQ[{a,b,c},x] && NonzeroQ[b^2-4*a*c] && PosQ[c] && PositiveQ[4*a-b^2/c]


Int[1/Sqrt[a_+b_.*x_+c_.*x_^2],x_Symbol] :=
  ArcTanh[(b+2*c*x)/(2*Rt[c,2]*Sqrt[a+b*x+c*x^2])]/Rt[c,2] /;
FreeQ[{a,b,c},x] && NonzeroQ[b^2-4*a*c] && PosQ[c] && Not[PositiveQ[4*a-b^2/c]]


Int[1/Sqrt[a_+b_.*x_+c_.*x_^2],x_Symbol] :=
  -ArcSin[(b+2*c*x)/(Rt[-c,2]*Sqrt[4*a-b^2/c])]/Rt[-c,2] /;
FreeQ[{a,b,c},x] && NonzeroQ[b^2-4*a*c] && NegQ[c] && PositiveQ[4*a-b^2/c]


Int[1/Sqrt[a_+b_.*x_+c_.*x_^2],x_Symbol] :=
  -ArcTan[(b+2*c*x)/(2*Rt[-c,2]*Sqrt[a+b*x+c*x^2])]/Rt[-c,2] /;
FreeQ[{a,b,c},x] && NonzeroQ[b^2-4*a*c] && NegQ[c] && Not[PositiveQ[4*a-b^2/c]]
...
Int[1/(Sqrt[d_.+e_.*x_]*Sqrt[a_.+b_.*x_+c_.*x_^2]),x_Symbol] :=
  2*ArcTan[e*Sqrt[a+b*x+c*x^2]/(Rt[2*c*d-b*e,2]*Sqrt[d+e*x])]/Rt[2*c*d-b*e,2] /;
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && PosQ[2*c*d-b*e]


Int[1/(Sqrt[d_+e_.*x_]*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  2*ArcTan[e*Sqrt[a+c*x^2]/(Rt[2*c*d,2]*Sqrt[d+e*x])]/Rt[2*c*d,2] /;
FreeQ[{a,c,d,e},x] && ZeroQ[c*d^2+a*e^2] && PosQ[c*d]


Int[1/(Sqrt[d_.+e_.*x_]*Sqrt[a_.+b_.*x_+c_.*x_^2]),x_Symbol] :=
  -2*ArcTanh[e*Sqrt[a+b*x+c*x^2]/(Rt[b*e-2*c*d,2]*Sqrt[d+e*x])]/Rt[b*e-2*c*d,2] /;
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && NegQ[2*c*d-b*e]


Int[1/(Sqrt[d_+e_.*x_]*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  -2*ArcTanh[e*Sqrt[a+c*x^2]/(Rt[-2*c*d,2]*Sqrt[d+e*x])]/Rt[-2*c*d,2] /;
FreeQ[{a,c,d,e},x] && ZeroQ[c*d^2+a*e^2] && NegQ[c*d]
...
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  ...
  (-1<=m<0 || m+p+1==0) && NonzeroQ[m+2*p+1] && Not[NegativeIntegerQ[m+2*p+2]]
...
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  NonzeroQ[m+p] && NonzeroQ[m+2*p+2] && RationalQ[m,p] && p>0 && m<-1 && NonzeroQ[m+p+1] && Not[NegativeIntegerQ[m+2*p+2]]
...
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  NonzeroQ[m+p] && NonzeroQ[m+2*p+2] && RationalQ[m,p] && p<-1 && 0<m<=1
...
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  NonzeroQ[m+p] && NonzeroQ[m+2*p+2] && RationalQ[m,p] && p<-1 && m>1 && Not[NegativeIntegerQ[m+2*p+2]]
...
FreeQ[{a,b,c,d,e,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && NonzeroQ[m+p] && 
  NonzeroQ[m+2*p+2] && RationalQ[m] && (m>=1 || PositiveIntegerQ[m+p]) && NonzeroQ[m+2*p+1]
...
FreeQ[{a,b,c,d,e,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && NonzeroQ[m+p] && 
  NonzeroQ[m+2*p+2] && RationalQ[m] && m<0 && NonzeroQ[m+p+1]
...
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[2*c*d-b*e] && PosQ[(b^2-4*a*c)/c]


Int[1/((d_+e_.*x_)*Sqrt[a_.+b_.*x_+c_.*x_^2]),x_Symbol] :=
  -2/(e*Rt[(4*a*c-b^2)/c,2])*ArcTanh[2*Sqrt[a+b*x+c*x^2]/Rt[(4*a*c-b^2)/c,2]] /;
FreeQ[{a,b,c,d,e},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[2*c*d-b*e] && NegQ[(b^2-4*a*c)/c]
...
Int[1/((d_+e_.*x_)*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  -1/Rt[c*d^2+a*e^2,2]*ArcTanh[(a*e-c*d*x)/(Rt[c*d^2+a*e^2,2]*Sqrt[a+c*x^2])] /;
...
Int[1/((d_+e_.*x_)*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  1/Rt[-c*d^2-a*e^2,2]*ArcTan[(a*e-c*d*x)/(Rt[-c*d^2-a*e^2,2]*Sqrt[a+c*x^2])] /;
...
Int[(e_.*x_)^m_/Sqrt[a_+c_.*x_^2],x_Symbol] :=
  Module[{q=Rt[-a*c,2]},
  Sqrt[(a+c*x^2)/a]/Sqrt[a+c*x^2]*Int[(e*x)^m/(Sqrt[1-c*x/q]*Sqrt[1+c*x/q]),x]] /;
FreeQ[{a,c,e},x] && RationalQ[m] && m^2==1/4
...
FreeQ[{a,b,c,d,e,m,p},x] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && NonzeroQ[2*c*d-b*e] && 
  If[RationalQ[m], m>1, SumSimplerQ[m,-2]] && NonzeroQ[m+2*p+1]
...
Int[(a_.+b_.*x_+c_.*x_^2)^p_/(d_.+e_.*x_),x_Symbol] :=
  2^(2*p-1)*(a+b*x+c*x^2)^p/(e*p*((e*(b-Rt[b^2-4*a*c,2]+2*c*x))/(c*(d+e*x)))^p*((e*(b+Rt[b^2-4*a*c,2]+2*c*x))/(c*(d+e*x)))^p)*
    AppellF1[-2*p,-p,-p,-2*p+1,(2*c*d-b*e-e*Rt[b^2-4*a*c,2])/(2*c*(d+e*x)),(2*c*d-b*e+e*Rt[b^2-4*a*c,2])/(2*c*(d+e*x))] /;
FreeQ[{a,b,c,d,e,p},x] && Not[IntegerQ[p]] && NonzeroQ[2*c*d-b*e-e*Rt[b^2-4*a*c,2]] && NonzeroQ[2*c*d-b*e+e*Rt[b^2-4*a*c,2]]


Int[(a_+c_.*x_^2)^p_/(d_.+e_.*x_),x_Symbol] :=
  2^(2*p-1)*(a+c*x^2)^p/(e*p*((2*e*(-Rt[-a*c,2]+c*x))/(c*(d+e*x)))^p*((2*e*(Rt[-a*c,2]+c*x))/(c*(d+e*x)))^p)*
    AppellF1[-2*p,-p,-p,-2*p+1,(c*d-e*Rt[-a*c,2])/(c*(d+e*x)),(c*d+e*Rt[-a*c,2])/(c*(d+e*x))] /;
FreeQ[{a,c,d,e,p},x] && Not[IntegerQ[p]] && NonzeroQ[c*d-e*Rt[-a*c,2]] && NonzeroQ[c*d+e*Rt[-a*c,2]]
...
FreeQ[{a,b,c,d,e,m,p},x] && Not[IntegerQ[p]] && NonzeroQ[2*c*d-b*e-e*Rt[b^2-4*a*c,2]] && NonzeroQ[2*c*d-b*e+e*Rt[b^2-4*a*c,2]] && 
...
FreeQ[{a,c,d,e,m,p},x] && Not[IntegerQ[p]] && NonzeroQ[c*d-e*Rt[-a*c,2]] && NonzeroQ[c*d+e*Rt[-a*c,2]] && Not[NegativeIntegerQ[m]]
...
FreeQ[{a,b,c,d,e,A,B,m},x] && ZeroQ[b^2-4*a*c] && ZeroQ[2*A*c-b*B]


Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  -A*B*(d+e*x)^(m+1)*(a+b*x+c*x^2)^(p+1)/(b*(p+1)*(A*e-B*d)) /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  ZeroQ[m+2*p+3]
...
FreeQ[{a,b,c,d,e,A,B},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && RationalQ[m,p] && p<-1 && m>0


Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  -A*B*(d+e*x)^(m+1)*(a+b*x+c*x^2)^(p+1)/(b*(p+1)*(A*e-B*d)) + 
  A*B*e*(m+2*p+3)/(b*(p+1)*(A*e-B*d))*Int[(d+e*x)^m*(a+b*x+c*x^2)^(p+1),x] /;
FreeQ[{a,b,c,d,e,A,B,m},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && RationalQ[p] && p<-1 && Not[RationalQ[m] && m<-1]


Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  (d+e*x)^(m+1)*(A+B*x)*(a+b*x+c*x^2)^p/(e*(m+1)) - 
  B*(2*p+1)/(e*(m+1))*Int[(d+e*x)^(m+1)*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && RationalQ[m] && m<-1 && NonzeroQ[2*p+1] && 
  (Not[RationalQ[p]] || p>0 && (Not[IntegerQ[m]] || m>=-2*p-2 || m<-4*(p+1)))


Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  B*(d+e*x)^m*(a+b*x+c*x^2)^(p+1)/(c*(m+2*p+2)) - 
  b*m*(A*e-B*d)/(2*A*c*(m+2*p+2))*Int[(d+e*x)^(m-1)*(A+B*x)*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && PositiveIntegerQ[m] && NonzeroQ[m+2*p+2] && (Not[RationalQ[p]] || m<2*p+2)


Int[(d_.+e_.*x_)^m_*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  2*A*B*(d+e*x)^(m+1)*(a+b*x+c*x^2)^(p+1)/(b*(m+1)*(A*e-B*d)) - 
  B*(m+2*p+3)/((m+1)*(A*e-B*d))*Int[(d+e*x)^(m+1)*(A+B*x)*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && RationalQ[m] && m<-1 && NonzeroQ[m+2*p+2]


Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  (d+e*x)^(m+1)*(A+B*x)*(a+b*x+c*x^2)^p/(e*(m+2*p+2)) + 
  (A*e-B*d)*(2*p+1)/(e*(m+2*p+2))*Int[(d+e*x)^m*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && ZeroQ[2*A*c-b*B] && 
  NonzeroQ[m+2*p+3] && NonzeroQ[m+2*p+2]


Int[(A_.+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_/(d_.+e_.*x_),x_Symbol] :=
  (2*A*c-b*B)/(2*c*d-b*e)*Int[(a+b*x+c*x^2)^p,x] - 
  (A*e-B*d)/(2*c*d-b*e)*Int[(b+2*c*x)*(a+b*x+c*x^2)^p/(d+e*x),x] /;
FreeQ[{a,b,c,d,e,A,B},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && NonzeroQ[2*A*c-b*B] && 
...
FreeQ[{a,b,c,d,e,A,B,m,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && NonzeroQ[2*A*c-b*B] && 
  (ZeroQ[m+2p+2] && NonzeroQ[m+1] || ZeroQ[2*c*d-b*e] && NonzeroQ[m-1])


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  (2*A*c-b*B)/(2*c*d-b*e)*Int[(d+e*x)^(m+1)*(a+b*x+c*x^2)^p,x] - 
  (A*e-B*d)/(2*c*d-b*e)*Int[(d+e*x)^m*(b+2*c*x)*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && NonzeroQ[2*A*c-b*B] && 
...
FreeQ[{a,b,c,d,e,A,B,p},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]] && NonzeroQ[2*A*c-b*B] && 
...
FreeQ[{a,b,c,d,e,f,g,m,n},x] && ZeroQ[b^2-4*a*c] && Not[IntegerQ[p]]


Int[(d_+e_.*x_)^m_.*(f_.+g_.*x_)^n_.*(a_.+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  Int[(d+e*x)^(m+p)*(f+g*x)^n*(a/d+c/e*x)^p,x] /;
FreeQ[{a,b,c,d,e,f,g,m,n},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && IntegerQ[p]


Int[(d_+e_.*x_)^m_.*(f_.+g_.*x_)^n_.*(a_+c_.*x_^2)^p_.,x_Symbol] :=
  Int[(d+e*x)^(m+p)*(f+g*x)^n*(a/d+c/e*x)^p,x] /;
FreeQ[{a,c,d,e,f,g,m,n},x] && ZeroQ[c*d^2+a*e^2] && IntegerQ[p]


Int[(d_+e_.*x_)^m_*(f_.+g_.*x_)^n_*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m*(f+g*x)^n*(a+b*x+c*x^2)^p,x],x] /;
FreeQ[{a,b,c,d,e,f,g,n},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && Not[IntegerQ[p]] && 
  (PositiveIntegerQ[m] || IntegersQ[m,n])


Int[(d_+e_.*x_)^m_*(f_.+g_.*x_)^n_*(a_+c_.*x_^2)^p_,x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m*(f+g*x)^n*(a+c*x^2)^p,x],x] /;
FreeQ[{a,c,d,e,f,g,n},x] && ZeroQ[c*d^2+a*e^2] && Not[IntegerQ[p]] && 
  (PositiveIntegerQ[m] || IntegersQ[m,n])


Int[(d_+e_.*x_)^m_*(f_.+g_.*x_)^n_*(a_+c_.*x_^2)^p_.,x_Symbol] :=
  Int[(d+e*x)^(m+p)*(f+g*x)^n*(a/d+c/e*x)^p,x] /;
FreeQ[{a,c,d,e,f,g,m,n},x] && ZeroQ[c*d^2+a*e^2] && PositiveQ[a] && PositiveQ[d]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  B*(d+e*x)^m*(a+b*x+c*x^2)^(p+1)/(c*(m+2*p+2)) /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  Not[IntegerQ[p]] && ZeroQ[m*(B*(c*d-b*e)+A*c*e)+e*(p+1)*(2*A*c-b*B)]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_+c_.*x_^2)^p_,x_Symbol] :=
  B*(d+e*x)^m*(a+c*x^2)^(p+1)/(c*(m+2*p+2)) /;
FreeQ[{a,c,d,e,A,B,m,p},x] && ZeroQ[c*d^2+a*e^2] && Not[IntegerQ[p]] && ZeroQ[m*(B*d+A*e)+2*A*e*(p+1)]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  (B*(c*d-b*e)+A*c*e)*(d+e*x)^m*(a+b*x+c*x^2)^(p+1)/(c*(p+1)*(2*c*d-b*e)) - 
  e*(m*(B*(c*d-b*e)+A*c*e)+e*(p+1)*(2*A*c-b*B))/(c*(p+1)*(2*c*d-b*e))*
    Int[(d+e*x)^(m-1)*(a+b*x+c*x^2)^(p+1),x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  Not[IntegerQ[p]] && RationalQ[m,p] && m>0 && p<-1


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_+c_.*x_^2)^p_,x_Symbol] :=
  (B*d+A*e)*(d+e*x)^m*(a+c*x^2)^(p+1)/(2*c*d*(p+1)) - 
  e*(m*(B*d+A*e)+2*A*e*(p+1))/(2*c*d*(p+1))*Int[(d+e*x)^(m-1)*(a+c*x^2)^(p+1),x] /;
FreeQ[{a,c,d,e,A,B,m,p},x] && ZeroQ[c*d^2+a*e^2] && 
  Not[IntegerQ[p]] && RationalQ[m,p] && m>0 && p<-1


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  (B*d-A*e)*(d+e*x)^m*(a+b*x+c*x^2)^(p+1)/((2*c*d-b*e)*(m+p+1)) + 
  (m*(B*(c*d-b*e)+A*c*e)+e*(p+1)*(2*A*c-b*B))/(e*(2*c*d-b*e)*(m+p+1))*
    Int[(d+e*x)^(m+1)*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  Not[IntegerQ[p]] && (RationalQ[m] && m<-1 && NonzeroQ[m+p] || ZeroQ[m+2*p+2]) && NonzeroQ[m+p+1]
...
Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  B*(d+e*x)^m*(a+b*x+c*x^2)^(p+1)/(c*(m+2*p+2)) + 
  (m*(B*(c*d-b*e)+A*c*e)+e*(p+1)*(2*A*c-b*B))/(c*e*(m+2*p+2))*
    Int[(d+e*x)^m*(a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && 
  Not[IntegerQ[p]] && NonzeroQ[m+2*p+2]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_+c_.*x_^2)^p_,x_Symbol] :=
  B*(d+e*x)^m*(a+c*x^2)^(p+1)/(c*(m+2*p+2)) + 
  (m*(B*d+A*e)+2*A*e*(p+1))/(e*(m+2*p+2))*Int[(d+e*x)^m*(a+c*x^2)^p,x] /;
FreeQ[{a,c,d,e,A,B,m,p},x] && ZeroQ[c*d^2+a*e^2] && Not[IntegerQ[p]] && NonzeroQ[m+2*p+2]
...
FreeQ[{a,b,c,d,e,f,g,m,n},x] && NonzeroQ[b^2-4*a*c] && ZeroQ[c*d^2-b*d*e+a*e^2] && Not[IntegerQ[p]]


Int[(d_+e_.*x_)^m_*(f_.+g_.*x_)^n_.*(a_+c_.*x_^2)^p_,x_Symbol] :=
  (a+c*x^2)^p/((d+e*x)^p*(a/d+(c*x)/e)^p)*Int[(d+e*x)^(m+p)*(f+g*x)^n*(a/d+c/e*x)^p,x] /;
FreeQ[{a,c,d,e,f,g,m,n},x] && ZeroQ[c*d^2+a*e^2] && Not[IntegerQ[p]]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)/(a_.+b_.*x_+c_.*x_^2),x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m*(A+B*x)/(a+b*x+c*x^2),x],x] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && IntegerQ[m]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)/(a_+c_.*x_^2),x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m*(A+B*x)/(a+c*x^2),x],x] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && IntegerQ[m]


Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)/(a_.+b_.*x_+c_.*x_^2),x_Symbol] :=
  B*(d+e*x)^m/(c*m) + 
  1/c*Int[(d+e*x)^(m-1)*Simp[A*c*d-a*B*e+(B*c*d-b*B*e+A*c*e)*x,x]/(a+b*x+c*x^2),x] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && FractionQ[m] && m>0


Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)/(a_+c_.*x_^2),x_Symbol] :=
  B*(d+e*x)^m/(c*m) + 
  1/c*Int[(d+e*x)^(m-1)*Simp[A*c*d-a*B*e+(B*c*d+A*c*e)*x,x]/(a+c*x^2),x] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && FractionQ[m] && m>0


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  2*B^2/Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTan[(Rt[B*c*(2*A*c*e-b*B*e),2]+2*B*c*Sqrt[d+e*x])/Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]] - 
  2*B^2/Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTan[(Rt[B*c*(2*A*c*e-b*B*e),2]-2*B*c*Sqrt[d+e*x])/Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  ZeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] && PosQ[B*c*(2*A*c*e+b*B*e-4*B*c*d)]


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_+c_.*x_^2)),x_Symbol] :=
  2*B^2/Rt[2*B*c^2*(A*e-2*B*d),2]*ArcTan[(Rt[2*A*B*c^2*e,2]+2*B*c*Sqrt[d+e*x])/Rt[2*B*c^2*(A*e-2*B*d),2]] - 
  2*B^2/Rt[2*B*c^2*(A*e-2*B*d),2]*ArcTan[(Rt[2*A*B*c^2*e,2]-2*B*c*Sqrt[d+e*x])/Rt[2*B*c^2*(A*e-2*B*d),2]] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && ZeroQ[A^2*c*e-2*A*B*c*d-a*B^2*e] && PosQ[B*c^2*(A*e-2*B*d)]


(* Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  -2*B^2/Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTan[Sqrt[d+e*x]*Rt[B*c*(2*A*c*e+b*B*e-4*B*c*d),2]/(c*(2*B*d-A*e+B*e*x))] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  ZeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] && PosQ[B*c*(-4*B*c*d+b*B*e+2*A*c*e)] *)


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  2*B^2/Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTanh[(Rt[B*c*(2*A*c*e-b*B*e),2]-2*B*c*Sqrt[d+e*x])/Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]] - 
  2*B^2/Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTanh[(Rt[B*c*(2*A*c*e-b*B*e),2]+2*B*c*Sqrt[d+e*x])/Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  ZeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] && NegQ[B*c*(2*A*c*e+b*B*e-4*B*c*d)]


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_+c_.*x_^2)),x_Symbol] :=
  2*B^2/Rt[-2*B*c^2*(A*e-2*B*d),2]*ArcTanh[(Rt[2*A*B*c^2*e,2]-2*B*c*Sqrt[d+e*x])/Rt[-2*B*c^2*(A*e-2*B*d),2]] - 
  2*B^2/Rt[-2*B*c^2*(A*e-2*B*d),2]*ArcTanh[(Rt[2*A*B*c^2*e,2]+2*B*c*Sqrt[d+e*x])/Rt[-2*B*c^2*(A*e-2*B*d),2]] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && ZeroQ[A^2*c*e-2*A*B*c*d-a*B^2*e] && NegQ[B*c^2*(A*e-2*B*d)]


(* Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  -2*B^2/Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]*ArcTanh[Sqrt[d+e*x]*Rt[-B*c*(2*A*c*e+b*B*e-4*B*c*d),2]/(c*(2*B*d-A*e+B*e*x))] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  ZeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] && NegQ[B*c*(2*A*c*e+b*B*e-4*B*c*d)] *)
...
(* Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  Module[{q=Rt[(c*d^2-b*d*e+a*e^2)/c,2]},
  (B/(2*e)-c*(B*d-A*e)*q/(2*e*(c*d^2-b*d*e+a*e^2)))*Int[(d+q+e*x)/(Sqrt[d+e*x]*(a+b*x+c*x^2)),x] + 
  (B/(2*e)+c*(B*d-A*e)*q/(2*e*(c*d^2-b*d*e+a*e^2)))*Int[(d-q+e*x)/(Sqrt[d+e*x]*(a+b*x+c*x^2)),x]] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  NonzeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] && NegativeQ[b^2-4*a*c] *)


(* Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_+c_.*x_^2)),x_Symbol] :=
  Module[{q=Rt[(c*d^2+a*e^2)/c,2]},
  (B/(2*e)-c*(B*d-A*e)*q/(2*e*(c*d^2+a*e^2)))*Int[(d+q+e*x)/(Sqrt[d+e*x]*(a+c*x^2)),x] + 
  (B/(2*e)+c*(B*d-A*e)*q/(2*e*(c*d^2+a*e^2)))*Int[(d-q+e*x)/(Sqrt[d+e*x]*(a+c*x^2)),x]] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[A^2*c*e-2*A*B*c*d-B^2*a*e] && NegativeQ[-a*c] *)


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_.+b_.*x_+c_.*x_^2)),x_Symbol] :=
  Module[{q=Rt[b^2-4*a*c,2]},
  (B+(2*A*c-b*B)/q)*Int[1/(Sqrt[d+e*x]*(b-q+2*c*x)),x] + 
  (B-(2*A*c-b*B)/q)*Int[1/(Sqrt[d+e*x]*(b+q+2*c*x)),x]] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && 
  NonzeroQ[A^2*c*e-2*A*B*c*d+B^2*(b*d-a*e)] (* && Not[NegativeQ[b^2-4*a*c]] *)


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*(a_+c_.*x_^2)),x_Symbol] :=
  Module[{q=Rt[-a*c,2]},
  (B/2+A*c/(2*q))*Int[1/(Sqrt[d+e*x]*(-q+c*x)),x] + 
  (B/2-A*c/(2*q))*Int[1/(Sqrt[d+e*x]*(q+c*x)),x]] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[A^2*c*e-2*A*B*c*d-B^2*a*e] (* && Not[NegativeQ[-a*c]] *)
...
FreeQ[{a,b,c,d,e,A,B,m},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && FractionQ[m] && m<-1


Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)/(a_+c_.*x_^2),x_Symbol] :=
  (A*e-B*d)*(d+e*x)^(m+1)/((m+1)*(c*d^2+a*e^2)) + 
  1/(c*d^2+a*e^2)*Int[(d+e*x)^(m+1)*Simp[A*c*d+a*B*e-c*(A*e-B*d)*x,x]/(a+c*x^2),x] /;
FreeQ[{a,c,d,e,A,B,m},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && FractionQ[m] && m<-1


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)/(a_.+b_.*x_+c_.*x_^2),x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m,(A+B*x)/(a+b*x+c*x^2),x],x] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && Not[RationalQ[m]]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)/(a_+c_.*x_^2),x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m,(A+B*x)/(a+c*x^2),x],x] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && Not[RationalQ[m]]


Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*Sqrt[b_.*x_+c_.*x_^2]),x_Symbol] :=
  Sqrt[x]*Sqrt[b+c*x]/Sqrt[b*x+c*x^2]*Int[(A+B*x)/(Sqrt[x]*Sqrt[b+c*x]*Sqrt[d+e*x]),x] /;
FreeQ[{b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d-b*e]


Int[(A_+B_.*x_)/(Sqrt[e_.*x_]*Sqrt[a_+b_.*x_+c_.*x_^2]),x_Symbol] :=
  Module[{q=Rt[b^2-4*a*c,2]},
  Sqrt[1+2*c*x/(b-q)]*Sqrt[1+2*c*x/(b+q)]/Sqrt[a+b*x+c*x^2]*Int[(A+B*x)/(Sqrt[e*x]*Sqrt[1+2*c*x/(b-q)]*Sqrt[1+2*c*x/(b+q)]),x]] /;
FreeQ[{a,b,c,e,A,B},x] && NonzeroQ[b^2-4*a*c]


Int[(A_+B_.*x_)/(Sqrt[e_.*x_]*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  Module[{q=Rt[-a*c,2]},
  Sqrt[(a+c*x^2)/a]/Sqrt[a+c*x^2]*Int[(A+B*x)/(Sqrt[e*x]*Sqrt[1-c*x/q]*Sqrt[1+c*x/q]),x]] /;
FreeQ[{a,c,e,A,B},x]
...
Int[(A_.+B_.*x_)/(Sqrt[d_.+e_.*x_]*Sqrt[a_+b_.*x_+c_.*x_^2]),x_Symbol] :=
  Module[{q=Rt[b^2-4*a*c,2]},
  Sqrt[(q*e-b*e-2*c*e*x)/(q*e-b*e+2*c*d)]*Sqrt[(q*e+b*e+2*c*e*x)/(q*e+b*e-2*c*d)]/Sqrt[a+b*x+c*x^2]*
    Int[(A+B*x)/(Sqrt[d+e*x]*Sqrt[(q*e-b*e)/(q*e-b*e+2*c*d)-2*c*e*x/(q*e-b*e+2*c*d)]*
      Sqrt[(q*e+b*e)/(q*e+b*e-2*c*d)+2*c*e*x/(q*e+b*e-2*c*d)]),x]] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2]


Int[(A_.+B_.*x_)/(Sqrt[d_+e_.*x_]*Sqrt[a_+c_.*x_^2]),x_Symbol] :=
  Module[{q=Rt[-a*c,2]},
  Sqrt[(q*e-c*e*x)/(q*e+c*d)]*Sqrt[(q*e+c*e*x)/(q*e-c*d)]/Sqrt[a+c*x^2]*
    Int[(A+B*x)/(Sqrt[d+e*x]*Sqrt[q*e/(q*e+c*d)-c*e*x/(q*e+c*d)]*Sqrt[q*e/(q*e-c*d)+c*e*x/(q*e-c*d)]),x]] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2]
...
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && RationalQ[p] && -1<p<0


Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)*(a_+c_.*x_^2)^p_.,x_Symbol] :=
  (A*e-B*d)*(d+e*x)^(m+1)*(a+c*x^2)^(p+1)/((m+1)*(c*d^2+a*e^2)) /;
FreeQ[{a,c,d,e,A,B,m,p},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && 
  ZeroQ[A*c*d+a*B*e] && ZeroQ[m+2*p+3] && NonzeroQ[m+1]


Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x)^m*(A+B*x)*(a+b*x+c*x^2)^p,x],x] /;
FreeQ[{a,b,c,d,e,A,B,m},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && PositiveIntegerQ[p]
...
Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  ...
  p/(e^2*(m+1)*(m+2*p+2))*
    Int[(d+e*x)^(m+1)*
      ...
      (a+b*x+c*x^2)^(p-1),x] /;
FreeQ[{a,b,c,d,e,A,B,m},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && 
...
FreeQ[{a,c,d,e,A,B,m},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && 
  RationalQ[p] && p>0 && (RationalQ[m] && m<-1 || p==1 || IntegerQ[p] && Not[RationalQ[m]]) && NonzeroQ[m+1] && NonzeroQ[m+2*p+2]
...
Int[(d_.+e_.*x_)^m_.*(A_+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  ...
  B*e*m/(2*c*(p+1))*Int[(d+e*x)^(m-1)*(a+b*x+c*x^2)^(p+1),x] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && 
  RationalQ[m,p] && m>0 && p<-1 && ZeroQ[2*A*c-b*B]
...
Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_,x_Symbol] :=
  ...
  1/((p+1)*(b^2-4*a*c))*
    Int[(d+e*x)^(m-1)*
      ...
      (a+b*x+c*x^2)^(p+1),x] /;
FreeQ[{a,b,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && 
  RationalQ[m,p] && p<-1 && m>0 && NonzeroQ[2*A*c-b*B]
...
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && RationalQ[m,p] && p<-1 && m>0
...
Int[(d_.+e_.*x_)^m_*(A_.+B_.*x_)*(a_+c_.*x_^2)^p_,x_Symbol] :=
  ...
  1/(2*a*c*(p+1)*(c*d^2+a*e^2))*
    Int[(d+e*x)^m*
      ...
      (a+c*x^2)^(p+1),x] /;
FreeQ[{a,c,d,e,A,B},x] && NonzeroQ[A*e-B*d] && NonzeroQ[c*d^2+a*e^2] && RationalQ[p] && p<-1
...
Int[(d_.+e_.*x_)^m_.*(A_.+B_.*x_)*(a_.+b_.*x_+c_.*x_^2)^p_.,x_Symbol] :=
  ...
  1/(c*(m+2*p+2))*
    Int[(d+e*x)^(m-1)*
      ...
      (a+b*x+c*x^2)^p,x] /;
FreeQ[{a,b,c,d,e,A,B,m,p},x] && NonzeroQ[A*e-B*d] && NonzeroQ[b^2-4*a*c] && NonzeroQ[c*d^2-b*d*e+a*e^2] && 
...
Int[1/((a_+b_.*x_+c_.*x_^2)*Sqrt[d_.+e_.*x_+f_.*x_^2]),x_Symbol] :=
  ...
  2*c/q*Int[1/((b+q+2*c*x)*Sqrt[d+e*x+f*x^2]),x]] /;
FreeQ[{a,b,c,d,e,f},x] && NonzeroQ[b^2-4*a*c]
...
Int[1/(x_*Sqrt[a_+b_.*x_^n_+c_.*x_^j_.]),x_Symbol] :=
  1/n*Subst[Int[1/(x*Sqrt[a+b*x+c*x^2]),x],x,x^n] /;
FreeQ[{a,b,c,n},x] && ZeroQ[j-2*n] && NonzeroQ[b^2-4*a*c]


Int[(a_+b_.*x_^n_+c_.*x_^j_.)^p_/x_,x_Symbol] :=
  (a+b*x^n+c*x^(2*n))^p/(2*n*p) + 
  1/2*Int[(2*a+b*x^n)*(a+b*x^n+c*x^(2*n))^(p-1)/x,x] /;
FreeQ[{a,b,c},x] && ZeroQ[j-2*n] && NonzeroQ[b^2-4*a*c] && Not[PositiveIntegerQ[p]] && 
  PositiveIntegerQ[n] && RationalQ[p] && p>0


Int[(a_+b_.*x_^n_+c_.*x_^j_.)^p_/x_,x_Symbol] :=
  -(b^2-2*a*c+b*c*x^n)*(a+b*x^n+c*x^(2*n))^(p+1)/(a*n*(p+1)*(b^2-4*a*c)) + 
  1/(a*(p+1)*(b^2-4*a*c))*
    Int[Simp[b^2*(p+1)-4*a*c*(p+1)+b*c*(2*p+3)*x^n,x]*(a+b*x^n+c*x^(2*n))^(p+1)/x,x] /;
FreeQ[{a,b,c},x] && ZeroQ[j-2*n] && NonzeroQ[b^2-4*a*c] && Not[PositiveIntegerQ[p]] && 
  PositiveIntegerQ[n] && RationalQ[p] && p<-1
...
Int[(a_+b_.*x_^n_+c_.*x_^j_.)^p_/x_,x_Symbol] :=
  (a+b*x^n+c*x^(2*n))^p/(2*n*p*(1+(b-Sqrt[b^2-4*a*c])/(2*c*x^n))^p*(1+(b+Sqrt[b^2-4*a*c])/(2*c*x^n))^p)*
    AppellF1[-2*p,-p,-p,1-2*p,-(b+Sqrt[b^2-4*a*c])/(2*c*x^n),-(b-Sqrt[b^2-4*a*c])/(2*c*x^n)] /;
FreeQ[{a,b,c,n,p},x] && ZeroQ[j-2*n] && Not[PositiveIntegerQ[p]]
...
Int[1/((a_+b_.*x_^2)*Sqrt[c_+d_.*x_^4]),x_Symbol] :=
  Simp[1/(a*Sqrt[c]*Sqrt[-Rt[-d/c,2]])*EllipticPi[b/(a*Rt[-d/c,2]), ArcSin[Sqrt[-Rt[-d/c,2]]*x], -1],x] /;
...
FreeQ[{a,b,c,m,n,q},x] && ZeroQ[r-(2*n-q)] && PosQ[n-q] && IntegerQ[p]


(* Int[x_^m_.*Sqrt[a_.*x_^q_.+b_.*x_^n_.+c_.*x_^r_.],x_Symbol] :=
  Sqrt[a*x^q+b*x^n+c*x^(2*n-q)]/(x^(q/2)*Sqrt[a+b*x^(n-q)+c*x^(2*(n-q))])*
    Int[x^(m+q/2)*Sqrt[a+b*x^(n-q)+c*x^(2*(n-q))],x] /;
FreeQ[{a,b,c,m,n,q},x] && ZeroQ[r-(2*n-q)] && PosQ[n-q] *)


(* Int[x_^m_.*(a_.*x_^q_.+b_.*x_^n_.+c_.*x_^r_.)^p_,x_Symbol] :=
  (a*x^q+b*x^n+c*x^(2*n-q))^p/(x^(p*q)*(a+b*x^(n-q)+c*x^(2*(n-q)))^p)*
    Int[x^(m+p*q)*(a+b*x^(n-q)+c*x^(2*(n-q)))^p,x] /;
FreeQ[{a,b,c,m,n,p,q},x] && ZeroQ[r-(2*n-q)] && PosQ[n-q] && Not[IntegerQ[p]] *)
...
Int[x_^m_.*(a_.*x_^q_.+b_.*x_^n_.+c_.*x_^r_.)^p_.,x_Symbol] :=
  Defer[Int][x^m*(a*x^q+b*x^n+c*x^(2*n-q))^p,x] /;
FreeQ[{a,b,c,m,n,p,q},x] && ZeroQ[r-(2*n-q)]
...
FreeQ[{a,b,c,A,B,m,n,p,q},x] && ZeroQ[j-(n-q)] && ZeroQ[r-(2*n-q)] && PosQ[n-q] && PositiveIntegerQ[p+1/2] *)


(* Int[x_^m_.*(A_+B_.*x_^j_.)*(a_.*x_^q_.+b_.*x_^n_.+c_.*x_^r_.)^p_,x_Symbol] :=
  x^(q/2)*Sqrt[a+b*x^(n-q)+c*x^(2*(n-q))]/Sqrt[a*x^q+b*x^n+c*x^(2*n-q)]*
    Int[x^(m+q*p)*(A+B*x^(n-q))*(a+b*x^(n-q)+c*x^(2*(n-q)))^p,x] /;
FreeQ[{a,b,c,A,B,m,n,p,q},x] && ZeroQ[j-(n-q)] && ZeroQ[r-(2*n-q)] && PosQ[n-q] && NegativeIntegerQ[p-1/2] *)
...
FreeQ[{a,b,c,A,B,j,k,m,p},x] && ZeroQ[q-(k-j)] && ZeroQ[n-(2*k-j)] && PosQ[k-j] && Not[IntegerQ[p]] *)


(* Int[x_^m_.*(A_+B_.*x_^r_.)*(a_.*x_^q_.+b_.*x_^n_.+c_.*x_^j_.)^p_.,x_Symbol] :=
  A*Int[x^m*(a*x^q+b*x^n+c*x^(2*n-q))^p,x] + 
  B*Int[x^(m+n-q)*(a*x^q+b*x^n+c*x^(2*n-q))^p,x] /;
FreeQ[{a,b,c,A,B,m,n,p,q},x] && ZeroQ[r-(n-q)] && ZeroQ[j-(2*n-q)] *)


(* Int[x_^m_.*(A_+B_.*x_^r_.)*(a_.*x_^q_.+c_.*x_^j_.)^p_.,x_Symbol] :=
  Module[{n=q+r},
  A*Int[x^m*(a*x^q+c*x^(2*n-q))^p,x] + 
  B*Int[x^(m+n-q)*(a*x^q+c*x^(2*n-q))^p,x] /;
 ZeroQ[j-(2*n-q)]] /;
FreeQ[{a,c,A,B,m,p,q},x] *)


Int[x_^m_.*(A_+B_.*x_^j_.)*(a_.*x_^q_.+b_.*x_^n_.+c_.*x_^r_.)^p_.,x_Symbol] :=
  Defer[Int][x^m*(A+B*x^(n-q))*(a*x^q+b*x^n+c*x^(2*n-q))^p,x] /;
FreeQ[{a,b,c,A,B,m,n,p,q},x] && ZeroQ[j-(n-q)] && ZeroQ[r-(2*n-q)]
