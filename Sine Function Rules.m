...
FreeQ[{c,d},x] && RationalQ[n] && n>1 && OddQ[n]
...
Int[(b_*cos[c_.+d_.*x_])^n_,x_Symbol] :=
  (b*Cos[c+d*x])^n/Cos[c+d*x]^n*Int[Cos[c+d*x]^n,x] /;
FreeQ[{b,c,d},x] && ZeroQ[n^2-1/4]


Int[(b_.*sin[c_.+d_.*x_])^n_,x_Symbol] :=
  -b*Cos[c+d*x]*(b*Sin[c+d*x])^(n-1)/(d*(Sin[c+d*x]^2)^((n-1)/2))*Hypergeometric2F1[1/2,(1-n)/2,3/2,Cos[c+d*x]^2] /;
FreeQ[{b,c,d},x] && Not[IntegerQ[2*n]] && RationalQ[n] && n>0


Int[(b_.*cos[c_.+d_.*x_])^n_,x_Symbol] :=
  b*Sin[c+d*x]*(b*Cos[c+d*x])^(n-1)/(d*(Cos[c+d*x]^2)^((n-1)/2))*Hypergeometric2F1[1/2,(1-n)/2,3/2,Sin[c+d*x]^2] /;
FreeQ[{b,c,d},x] && Not[IntegerQ[2*n]] && RationalQ[n] && n>0


Int[(b_.*sin[c_.+d_.*x_])^n_,x_Symbol] :=
  -Cos[c+d*x]*(b*Sin[c+d*x])^(n+1)/(b*d*(Sin[c+d*x]^2)^((n+1)/2))*Hypergeometric2F1[1/2,(1-n)/2,3/2,Cos[c+d*x]^2] /;
FreeQ[{b,c,d,n},x] && Not[IntegerQ[2*n]] && Not[RationalQ[n] && n>0]


Int[(b_.*cos[c_.+d_.*x_])^n_,x_Symbol] :=
  Sin[c+d*x]*(b*Cos[c+d*x])^(n+1)/(b*d*(Cos[c+d*x]^2)^((n+1)/2))*Hypergeometric2F1[1/2,(1-n)/2,3/2,Sin[c+d*x]^2] /;
FreeQ[{b,c,d,n},x] && Not[IntegerQ[2*n]] && Not[RationalQ[n] && n>0]
...
Int[(a_+b_.*sin[c_.+d_.*x_])^n_,x_Symbol] :=
 -Sqrt[2]*(a+b)^n*Cos[c+d*x]/(d*Sqrt[1+Sin[c+d*x]])*AppellF1[1/2,1/2,-n,3/2,(1-Sin[c+d*x])/2,b*(1-Sin[c+d*x])/(a+b)] /;
FreeQ[{a,b,c,d,n},x] && NonzeroQ[a^2-b^2] && Not[IntegerQ[2*n]] && PositiveQ[a+b]


Int[(a_+b_.*cos[c_.+d_.*x_])^n_,x_Symbol] :=
 Sqrt[2]*(a+b)^n*Sin[c+d*x]/(d*Sqrt[1+Cos[c+d*x]])*AppellF1[1/2,1/2,-n,3/2,(1-Cos[c+d*x])/2,b*(1-Cos[c+d*x])/(a+b)] /;
FreeQ[{a,b,c,d,n},x] && NonzeroQ[a^2-b^2] && Not[IntegerQ[2*n]] && PositiveQ[a+b]
...
Int[(a_+b_.*sin[c_.+d_.*x_])^n_,x_Symbol] :=
 (a+b*Sin[c+d*x])^n/((a+b*Sin[c+d*x])/(a+b))^n*Int[(a/(a+b)+b*Sin[c+d*x]/(a+b))^n,x] /;
FreeQ[{a,b,c,d,n},x] && NonzeroQ[a^2-b^2] && Not[IntegerQ[2*n]] && Not[PositiveQ[a+b]]


Int[(a_+b_.*cos[c_.+d_.*x_])^n_,x_Symbol] :=
 (a+b*Cos[c+d*x])^n/((a+b*Cos[c+d*x])/(a+b))^n*Int[(a/(a+b)+b*Cos[c+d*x]/(a+b))^n,x] /;
FreeQ[{a,b,c,d,n},x] && NonzeroQ[a^2-b^2] && Not[IntegerQ[2*n]] && Not[PositiveQ[a+b]]
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_]),x_Symbol] :=
  -2^(3/2)*d*((b*c+a*d)/d)^m*Cos[e+f*x]/(f*Sqrt[(c+d*Sin[e+f*x])/c])*
...
Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_]),x_Symbol] :=
  2^(3/2)*d*((b*c+a*d)/d)^m*Sin[e+f*x]/(f*Sqrt[(c+d*Cos[e+f*x])/c])*
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_]),x_Symbol] :=
  (a+b*Sin[e+f*x])^m/(d*(a+b*Sin[e+f*x])/(b*c+a*d))^m*Int[(a*d/(b*c+a*d)+b*d*Sin[e+f*x]/(b*c+a*d))^m*(c+d*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,d,e,f,m},x] && NonzeroQ[b*c-a*d] && NonzeroQ[a^2-b^2] && ZeroQ[c^2-d^2] && Not[IntegerQ[2*m]] && 
  Not[PositiveQ[(b*c+a*d)/d]]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  (a+b*Cos[e+f*x])^m/(d*(a+b*Cos[e+f*x])/(b*c+a*d))^m*Int[(a*d/(b*c+a*d)+b*d*Cos[e+f*x]/(b*c+a*d))^m*(c+d*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,d,e,f,m},x] && NonzeroQ[b*c-a*d] && NonzeroQ[a^2-b^2] && ZeroQ[c^2-d^2] && Not[IntegerQ[2*m]] && 
  Not[PositiveQ[(b*c+a*d)/d]]
...
Int[Sqrt[a_+b_.*sin[e_.+f_.*x_]]*(c_.+d_.*sin[e_.+f_.*x_])^n_,x_Symbol] :=
  -2*b*Cos[e+f*x]/(f*(b/(b*c+a*d))^n*Sqrt[a+b*Sin[e+f*x]])*Hypergeometric2F1[1/2,-n,3/2,d*(a-b*Sin[e+f*x])/(b*c+a*d)] /;
FreeQ[{a,b,c,d,e,f,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[IntegerQ[2*n]] && PositiveQ[b/(b*c+a*d)]


Int[Sqrt[a_+b_.*cos[e_.+f_.*x_]]*(c_.+d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  2*b*Sin[e+f*x]/(f*(b/(b*c+a*d))^n*Sqrt[a+b*Cos[e+f*x]])*Hypergeometric2F1[1/2,-n,3/2,d*(a-b*Cos[e+f*x])/(b*c+a*d)] /;
FreeQ[{a,b,c,d,e,f,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[IntegerQ[2*n]] && PositiveQ[b/(b*c+a*d)]


Int[Sqrt[a_+b_.*sin[e_.+f_.*x_]]*(c_.+d_.*sin[e_.+f_.*x_])^n_,x_Symbol] :=
  (c+d*Sin[e+f*x])^n/(b*(c+d*Sin[e+f*x])/(b*c+a*d))^n*Int[Sqrt[a+b*Sin[e+f*x]]*(b*c/(b*c+a*d)+b*d*Sin[e+f*x]/(b*c+a*d))^n,x] /;
FreeQ[{a,b,c,d,e,f,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[IntegerQ[2*n]] && 
  Not[PositiveQ[b/(b*c+a*d)]]


Int[Sqrt[a_+b_.*cos[e_.+f_.*x_]]*(c_.+d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  (c+d*Cos[e+f*x])^n/(b*(c+d*Cos[e+f*x])/(b*c+a*d))^n*Int[Sqrt[a+b*Cos[e+f*x]]*(b*c/(b*c+a*d)+b*d*Cos[e+f*x]/(b*c+a*d))^n,x] /;
FreeQ[{a,b,c,d,e,f,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[IntegerQ[2*n]] && 
  Not[PositiveQ[b/(b*c+a*d)]]
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  -2^(m+1/2)*a^(m-1)*b*((b*c+a*d)/b)^n*Cos[e+f*x]/(f*Sqrt[(a+b*Sin[e+f*x])/a])*
    AppellF1[1/2,1/2-m,-n,3/2,(a-b*Sin[e+f*x])/(2*a),d*(a-b*Sin[e+f*x])/(b*c+a*d)] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && (IntegerQ[m] || PositiveQ[a]) && 
  (IntegerQ[n] || PositiveQ[(b*c+a*d)/b])


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  2^(m+1/2)*a^(m-1)*b*((b*c+a*d)/b)^n*Sin[e+f*x]/(f*Sqrt[(a+b*Cos[e+f*x])/a])*
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_,x_Symbol] :=
  (c+d*Sin[e+f*x])^n/(b*(c+d*Sin[e+f*x])/(b*c+a*d))^n*Int[(a+b*Sin[e+f*x])^m*(b*c/(b*c+a*d)+b*d*Sin[e+f*x]/(b*c+a*d))^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && (IntegerQ[m] || PositiveQ[a]) && 
  Not[IntegerQ[n]] && Not[PositiveQ[(b*c+a*d)/b]]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  (c+d*Cos[e+f*x])^n/(b*(c+d*Cos[e+f*x])/(b*c+a*d))^n*Int[(a+b*Cos[e+f*x])^m*(b*c/(b*c+a*d)+b*d*Cos[e+f*x]/(b*c+a*d))^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && (IntegerQ[m] || PositiveQ[a]) && 
  Not[IntegerQ[n]] && Not[PositiveQ[(b*c+a*d)/b]]


Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(m-1/2)*Sqrt[a+b*Sin[e+f*x]]/Sqrt[1+b/a*Sin[e+f*x]]*Int[(1+b/a*Sin[e+f*x])^m*(c+d*Sin[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && 
  PositiveIntegerQ[m+1/2]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(m-1/2)*Sqrt[a+b*Cos[e+f*x]]/Sqrt[1+b/a*Cos[e+f*x]]*Int[(1+b/a*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && 
  PositiveIntegerQ[m+1/2]


Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(m+1/2)*Sqrt[1+b/a*Sin[e+f*x]]/Sqrt[a+b*Sin[e+f*x]]*Int[(1+b/a*Sin[e+f*x])^m*(c+d*Sin[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && 
  NegativeIntegerQ[m-1/2]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(m+1/2)*Sqrt[1+b/a*Cos[e+f*x]]/Sqrt[a+b*Cos[e+f*x]]*Int[(1+b/a*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && 
  NegativeIntegerQ[m-1/2]


Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  (a+b*Sin[e+f*x])^m/(1+b/a*Sin[e+f*x])^m*Int[(1+b/a*Sin[e+f*x])^m*(c+d*Sin[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && Not[IntegerQ[2*m]]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  (a+b*Cos[e+f*x])^m/(1+b/a*Cos[e+f*x])^m*Int[(1+b/a*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && Not[PositiveQ[a]] && Not[IntegerQ[2*m]]
...
(* ::Subsection::Closed:: *)
(*2.2 (a+b sin)^m (c+d sin)^n (A+B sin)*)
...
(* ::Subsection::Closed:: *)
(*2.4 (a+b sin)^m (c+d sin)^n (A+B sin+C sin^2)*)
...
Int[(g_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(2*m)/g^(2*m)*Int[(g*Cos[e+f*x])^(2*m+p)*(c+d*Sin[e+f*x])^n/(a-b*Sin[e+f*x])^m,x] /;
FreeQ[{a,b,c,d,e,f,g,n,p},x] && ZeroQ[a^2-b^2] && NegativeIntegerQ[m]


Int[(g_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^(2*m)/g^(2*m)*Int[(g*Sin[e+f*x])^(2*m+p)*(c+d*Cos[e+f*x])^n/(a-b*Cos[e+f*x])^m,x] /;
FreeQ[{a,b,c,d,e,f,g,n,p},x] && ZeroQ[a^2-b^2] && NegativeIntegerQ[m]


Int[(g_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  -b*(g*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m*(c+d*Sin[e+f*x])^n/
    (a*f*g*(p+1)*((a+b*Sin[e+f*x])/(2*a))^((2*m+p+1)/2)*(b*(c+d*Sin[e+f*x])/(b*c+a*d))^n)*
    AppellF1[(p+1)/2,-(2*m+p-1)/2,-n,(p+3)/2,(a-b*Sin[e+f*x])/(2*a),d*(a-b*Sin[e+f*x])/(b*c+a*d)] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x] && ZeroQ[a^2-b^2]


Int[(g_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  b*(g*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n/
    (a*f*g*(p+1)*((a+b*Cos[e+f*x])/(2*a))^((2*m+p+1)/2)*(b*(c+d*Cos[e+f*x])/(b*c+a*d))^n)*
    AppellF1[(p+1)/2,-(2*m+p-1)/2,-n,(p+3)/2,(a-b*Cos[e+f*x])/(2*a),d*(a-b*Cos[e+f*x])/(b*c+a*d)] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x] && ZeroQ[a^2-b^2]
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_+d_.*sin[e_.+f_.*x_])^n_*(g_.*sin[e_.+f_.*x_])^p_,x_Symbol] :=
  Sqrt[a+b*Sin[e+f*x]]*Sqrt[c+d*Sin[e+f*x]]/(f*Cos[e+f*x])*
    Subst[Int[(a+b*x)^(m-1/2)*(c+d*x)^(n-1/2)*(g*x)^p,x],x,Sin[e+f*x]] /;
...
Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_+d_.*cos[e_.+f_.*x_])^n_*(g_.*cos[e_.+f_.*x_])^p_,x_Symbol] :=
  -Sqrt[a+b*Cos[e+f*x]]*Sqrt[c+d*Cos[e+f*x]]/(f*Sin[e+f*x])*
    Subst[Int[(a+b*x)^(m-1/2)*(c+d*x)^(n-1/2)*(g*x)^p,x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && ZeroQ[c^2-d^2]


Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_+d_.*sin[e_.+f_.*x_])^n_*(g_.*sin[e_.+f_.*x_])^p_,x_Symbol] :=
  Sqrt[a-b*Sin[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(f*Cos[e+f*x])*
    Subst[Int[(a+b*x)^(m-1/2)*(c+d*x)^n*(g*x)^p/Sqrt[a-b*x],x],x,Sin[e+f*x]] /;
...
Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_+d_.*cos[e_.+f_.*x_])^n_*(g_.*cos[e_.+f_.*x_])^p_,x_Symbol] :=
  -Sqrt[a-b*Cos[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(f*Sin[e+f*x])*
    Subst[Int[(a+b*x)^(m-1/2)*(c+d*x)^n*(g*x)^p/Sqrt[a-b*x],x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x] && NonzeroQ[b*c-a*d] && ZeroQ[a^2-b^2] && NonzeroQ[c^2-d^2] && IntegerQ[m-1/2]
...
Int[(a_+b_.*sin[e_.+f_.*x_])^m_*(c_+d_.*sin[e_.+f_.*x_])^n_*(g_.*sin[e_.+f_.*x_])^p_,x_Symbol] :=
  Defer[Int][(a+b*Sin[e+f*x])^m*(c+d*Sin[e+f*x])^n*(g*Sin[e+f*x])^p,x] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x]


Int[(a_+b_.*cos[e_.+f_.*x_])^m_*(c_+d_.*cos[e_.+f_.*x_])^n_*(g_.*cos[e_.+f_.*x_])^p_,x_Symbol] :=
  Defer[Int][(a+b*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n*(g*Cos[e+f*x])^p,x] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x]
...
(* ::Subsection::Closed:: *)
(*9 trig^m (a+b sin^n+c sin^(2 n))^p*)
