...
Int[(d_+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*Sqrt[x_]])^p_.,x_Symbol] :=
  2*Subst[Int[x*(d+e*x^2)^q*(a+b*ArcTan[c*x])^p,x],x,Sqrt[x]] /;
FreeQ[{a,b,c,d,e,p,q},x]


Int[(d_+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*Sqrt[x_]])^p_.,x_Symbol] :=
  2*Subst[Int[x*(d+e*x^2)^q*(a+b*ArcCot[c*x])^p,x],x,Sqrt[x]] /;
FreeQ[{a,b,c,d,e,p,q},x]


Int[(d_+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*x_^n_.]),x_Symbol] :=
  (d+e*x)^(q+1)*(a+b*ArcTan[c*x^n])/(e*(q+1)) - 
  b*c*n/(e*(q+1))*Int[x^(n-1)*(d+e*x)^(q+1)/(1+c^2*x^(2*n)),x] /;
FreeQ[{a,b,c,d,e,q,n},x] && NeQ[q,-1]


Int[(d_+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*x_^n_.]),x_Symbol] :=
  (d+e*x)^(q+1)*(a+b*ArcCot[c*x^n])/(e*(q+1)) + 
  b*c*n/(e*(q+1))*Int[x^(n-1)*(d+e*x)^(q+1)/(1+c^2*x^(2*n)),x] /;
FreeQ[{a,b,c,d,e,q,n},x] && NeQ[q,-1]


Int[(d_.+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*x_^n_.])^p_.,x_Symbol] :=
  Unintegrable[(d+e*x)^q*(a+b*ArcTan[c*x^n])^p,x] /;
FreeQ[{a,b,c,d,e,q,n,p},x]


Int[(d_.+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*x_^n_.])^p_.,x_Symbol] :=
  Unintegrable[(d+e*x)^q*(a+b*ArcCot[c*x^n])^p,x] /;
FreeQ[{a,b,c,d,e,q,n,p},x]
...
Int[x_^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*Sqrt[x_]])^p_.,x_Symbol] :=
  2*Subst[Int[x^(2*m+1)*(d+e*x^2)^q*(a+b*ArcTan[c*x])^p,x],x,Sqrt[x]] /;
FreeQ[{a,b,c,d,e,p,q},x] && IntegerQ[2*m]


Int[x_^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*Sqrt[x_]])^p_.,x_Symbol] :=
  2*Subst[Int[x^(2*m+1)*(d+e*x^2)^q*(a+b*ArcCot[c*x])^p,x],x,Sqrt[x]] /;
FreeQ[{a,b,c,d,e,p,q},x] && IntegerQ[2*m]


Int[(f_.*x_)^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*x_^n_.]),x_Symbol] :=
  With[{u=IntHide[(f*x)^m*(d+e*x)^q,x]},
  Dist[(a+b*ArcTan[c*x^n]),u] - b*c*n*Int[SimplifyIntegrand[u*x^(n-1)/(1+c^2*x^(2*n)),x],x]] /;
FreeQ[{a,b,c,d,e,q,n},x] && NeQ[q,-1] && IntegerQ[2*m] && (IGtQ[m,0] && IGtQ[q,0] || ILtQ[m+q+1,0] && LtQ[m*q,0])


Int[(f_.*x_)^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*x_^n_.]),x_Symbol] :=
  With[{u=IntHide[(f*x)^m*(d+e*x)^q,x]},
  Dist[(a+b*ArcCot[c*x^n]),u] + b*c*n*Int[SimplifyIntegrand[u*x^(n-1)/(1+c^2*x^(2*n)),x],x]] /;
FreeQ[{a,b,c,d,e,q,n},x] && NeQ[q,-1] && IntegerQ[2*m] && (IGtQ[m,0] && IGtQ[q,0] || ILtQ[m+q+1,0] && LtQ[m*q,0])


Int[(f_.*x_)^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcTan[c_.*x_^n_.])^p_.,x_Symbol] :=
  Unintegrable[(f*x)^m*(d+e*x)^q*(a+b*ArcTan[c*x^n])^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n,p,q},x]


Int[(f_.*x_)^m_.*(d_.+e_.*x_)^q_.*(a_.+b_.*ArcCot[c_.*x_^n_.])^p_.,x_Symbol] :=
  Unintegrable[(f*x)^m*(d+e*x)^q*(a+b*ArcCot[c*x^n])^p,x] /;
FreeQ[{a,b,c,d,e,f,m,n,p,q},x]
...
Int[(d_+e_.*x_^2)^q_.*(a_.+b_.*ArcTan[c_.*x_])^p_.,x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x^2)^q*(a+b*ArcTan[c*x])^p,x],x] /;
FreeQ[{a,b,c,d,e},x] && IntegerQ[q] && IGtQ[p,0]


Int[(d_+e_.*x_^2)^q_.*(a_.+b_.*ArcCot[c_.*x_])^p_.,x_Symbol] :=
  Int[ExpandIntegrand[(d+e*x^2)^q*(a+b*ArcCot[c*x])^p,x],x] /;
FreeQ[{a,b,c,d,e},x] && IntegerQ[q] && IGtQ[p,0]


Int[(d_.+e_.*x_^2)^q_.*(a_.+b_.*ArcTan[c_.*x_])^p_.,x_Symbol] :=
  Unintegrable[(d+e*x^2)^q*(a+b*ArcTan[c*x])^p,x] /;
FreeQ[{a,b,c,d,e,p,q},x]


Int[(d_.+e_.*x_^2)^q_.*(a_.+b_.*ArcCot[c_.*x_])^p_.,x_Symbol] :=
  Unintegrable[(d+e*x^2)^q*(a+b*ArcCot[c*x])^p,x] /;
FreeQ[{a,b,c,d,e,p,q},x]
...
FreeQ[{a,b,c,d,e,f,m},x] && EqQ[e,c^2*d] && IGtQ[p,0] && IGtQ[q,1]
...
Int[(f_.*x_)^m_.*(d_+e_.*x_^2)^q_.*(a_.+b_.*ArcTan[c_.*x_])^p_.,x_Symbol] :=
  Int[ExpandIntegrand[(a+b*ArcTan[c*x])^p,(f*x)^m*(d+e*x^2)^q,x],x] /;
FreeQ[{a,b,c,d,e,f,m},x] && IntegerQ[q] && IGtQ[p,0] && (GtQ[q,0] || LtQ[q,-1] && IntegerQ[m] && NeQ[m,1])


Int[(f_.*x_)^m_.*(d_+e_.*x_^2)^q_.*(a_.+b_.*ArcCot[c_.*x_])^p_.,x_Symbol] :=
  Int[ExpandIntegrand[(a+b*ArcCot[c*x])^p,(f*x)^m*(d+e*x^2)^q,x],x] /;
FreeQ[{a,b,c,d,e,f,m},x] && IntegerQ[q] && IGtQ[p,0] && (GtQ[q,0] || LtQ[q,-1] && IntegerQ[m] && NeQ[m,1])
...
Int[(f_.*x_)^m_.*(d_.+e_.*x_^2)^q_.*(a_.+b_.*ArcTan[c_.*x_])^p_.,x_Symbol] :=
  Unintegrable[(f*x)^m*(d+e*x^2)^q*(a+b*ArcTan[c*x])^p,x] /;
FreeQ[{a,b,c,d,e,f,m,p,q},x]


Int[(f_.*x_)^m_.*(d_.+e_.*x_^2)^q_.*(a_.+b_.*ArcCot[c_.*x_])^p_.,x_Symbol] :=
  Unintegrable[(f*x)^m*(d+e*x^2)^q*(a+b*ArcCot[c*x])^p,x] /;
FreeQ[{a,b,c,d,e,f,m,p,q},x]
...
FreeQ[{a,b,c,d,e,m},x] && IntegerQ[m] && NeQ[m,-1]
...
Int[(d_.+e_.*x_)^m_.*(a_.+b_.*ArcSec[c_.*x_]),x_Symbol] :=
  (d+e*x)^(m+1)*(a+b*ArcSec[c*x])/(e*(m+1)) -
  b*c*x/(e*(m+1)*Sqrt[c^2*x^2])*Int[SimplifyIntegrand[(d+e*x)^(m+1)/(x*Sqrt[c^2*x^2-1]),x],x] /;
...
Int[u_*(a_.+b_.*ArcSec[c_.*x_]),x_Symbol] :=
  With[{v=IntHide[u,x]},  
  Dist[(a+b*ArcSec[c*x]),v,x] - b*c*x/Sqrt[c^2*x^2]*Int[SimplifyIntegrand[v/(x*Sqrt[c^2*x^2-1]),x],x] /;
 InverseFunctionFreeQ[v,x]] /;
FreeQ[{a,b,c},x]
...
Int[u_*(a_.+b_.*ArcCsc[c_.*x_]),x_Symbol] :=
  With[{v=IntHide[u,x]},  
  Dist[(a+b*ArcCsc[c*x]),v,x] + b*c*x/Sqrt[c^2*x^2]*Int[SimplifyIntegrand[v/(x*Sqrt[c^2*x^2-1]),x],x] /;
 InverseFunctionFreeQ[v,x]] /;
FreeQ[{a,b,c},x]
