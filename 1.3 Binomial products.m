...
FreeQ[{a,b},x] && PositiveIntegerQ[n] && RationalQ[p] && p<-1 && 
  (IntegerQ[2*p] || n==2 && IntegerQ[4*p] || n==2 && IntegerQ[3*p] || Denominator[p+1/n]<Denominator[p] && Not[n==2 && p==-7/6])
...
Int[1/(a_+b_.*x_^2)^(1/4),x_Symbol] :=
  2*x/(a+b*x^2)^(1/4) - 2/(a^(1/4)*Rt[b/a,2])*EllipticE[1/2*ArcTan[Rt[b/a,2]*x],2] /;
...
FreeQ[{a1,b1,a2,b2,n,p},x] && ZeroQ[a2*b1+a1*b2] && (IntegerQ[p] || PositiveQ[a1] && PositiveQ[a2])


Int[(a1_+b1_.*x_^n_.)^p_.*(a2_+b2_.*x_^n_.)^p_.,x_Symbol] :=
  x*(a1+b1*x^n)^p*(a2+b2*x^n)^p/(2*n*p+1) + 
  2*a1*a2*n*p/(2*n*p+1)*Int[(a1+b1*x^n)^(p-1)*(a2+b2*x^n)^(p-1),x] /;
FreeQ[{a1,b1,a2,b2},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[p] && p>0 && 
...
FreeQ[{a1,b1,a2,b2},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[p] && p<-1 && 
  (IntegerQ[2*p] || Denominator[p+1/n]<Denominator[p])


Int[(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  -Subst[Int[(a1+b1*x^(-n))^p*(a2+b2*x^(-n))^p/x^2,x],x,1/x] /;
FreeQ[{a1,b1,a2,b2,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[2*n]


Int[(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  With[{k=Denominator[2*n]},
  k*Subst[Int[x^(k-1)*(a1+b1*x^(k*n))^p*(a2+b2*x^(k*n))^p,x],x,x^(1/k)]] /;
FreeQ[{a1,b1,a2,b2,p},x] && ZeroQ[a2*b1+a1*b2] && FractionQ[2*n]


Int[(a1_.+b1_.*x_^n_)^p_*(a2_.+b2_.*x_^n_)^p_,x_Symbol] :=
  (a1+b1*x^n)^FracPart[p]*(a2+b2*x^n)^FracPart[p]/(a1*a2+b1*b2*x^(2*n))^FracPart[p]*Int[(a1*a2+b1*b2*x^(2*n))^p,x] /;
FreeQ[{a1,b1,a2,b2,n,p},x] && ZeroQ[a2*b1+a1*b2] && Not[IntegerQ[p]]
...
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && (IntegerQ[p] || PositiveQ[a1] && PositiveQ[a2])
...
(* Int[x_^m_.*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  1/(2*n)*Subst[Int[(a1+b1*Sqrt[x])^p*(a2+b2*Sqrt[x])^p,x],x,x^(2*n)] /;
FreeQ[{a1,b1,a2,b2,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && ZeroQ[m-2*n+1] *)
...
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && ZeroQ[(m+1)/(2*n)+p+1] && NonzeroQ[m+1]
...
FreeQ[{a1,b1,a2,b2,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[Simplify[(m+1)/(2*n)]]
...
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[Simplify[(m+1)/(2*n)]]
...
FreeQ[{a1,b1,a2,b2,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[Simplify[(m+1)/(2*n)+p+1]] && NonzeroQ[m+1]
...
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[Simplify[(m+1)/(2*n)+p+1]] && NonzeroQ[p+1]
...
Int[x_^m_.*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
 ...
 k!=1] /;
FreeQ[{a1,b1,a2,b2,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && IntegerQ[m]
...
FreeQ[{a1,b1,a2,b2,c,m},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[m,p] && p>0 && NonzeroQ[m+2*n*p+1] && 
...
FreeQ[{a,b,c,m},x] && PositiveIntegerQ[n] && RationalQ[m,p] && p>0 && NonzeroQ[m+n*p+1] && IntBinomialQ[a,b,c,n,m,p,x]
...
FreeQ[{a,b,c},x] && PositiveIntegerQ[n] && RationalQ[m,p] && p<-1 && m+1>n && Not[NegativeIntegerQ[(m+n*(p+1)+1)/n]] && 
  IntBinomialQ[a,b,c,n,m,p,x]
...
FreeQ[{a1,b1,a2,b2,c},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[m,p] && p<-1 && m+1>2*n && 
...
Int[(c_.*x_)^m_.*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  -(c*x)^(m+1)*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1)/(2*a1*a2*c*n*(p+1)) + 
  (m+2*n*(p+1)+1)/(2*a1*a2*n*(p+1))*Int[(c*x)^m*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1),x] /;
FreeQ[{a1,b1,a2,b2,c,m},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[m,p] && p<-1 && 
  IntBinomialQ[a1*a2,b1*b2,c,n,m,p,x]
...
(* Int[x_/Sqrt[a_+b_.*x_^3],x_Symbol] :=
  With[{q=Rt[b/a,3]},
  (-1+Sqrt[3])/q*Int[1/Sqrt[a+b*x^3],x] - 1/q*Int[(-1+Sqrt[3]-q*x)/Sqrt[a+b*x^3],x]] /;
FreeQ[{a,b},x] && PosQ[a] *)


Int[x_/Sqrt[a_+b_.*x_^3],x_Symbol] :=
  With[{q=Rt[b/a,3]},
  Sqrt[2]/(Sqrt[2+Sqrt[3]]*q)*Int[1/Sqrt[a+b*x^3],x] - 1/q*Int[(-1+Sqrt[3]-q*x)/Sqrt[a+b*x^3],x]] /;
FreeQ[{a,b},x] && PosQ[a]
...
Int[1/((c_.*x_)^(3/2)*(a_+b_.*x_^2)^(1/4)),x_Symbol] :=
  2/c*Subst[Int[1/(x^2*(a+b*x^4/c^2)^(1/4)),x],x,Sqrt[c*x]] /;
FreeQ[{a,b,c},x]
...
FreeQ[{a,b,c,p},x] && PositiveIntegerQ[n] && RationalQ[m] && m>n-1 && NonzeroQ[m+n*p+1] && IntBinomialQ[a,b,c,n,m,p,x]
...
FreeQ[{a1,b1,a2,b2,c,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[m] && m>2*n-1 && 
  NonzeroQ[m+2*n*p+1] && IntBinomialQ[a1*a2,b1*b2,c,n,m,p,x]


Int[(c_.*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  c^(2*n-1)*(c*x)^(m-2*n+1)*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1)/(b1*b2*(m+2*n*p+1)) - 
  a1*a2*c^(2*n)*(m-2*n+1)/(b1*b2*(m+2*n*p+1))*Int[(c*x)^(m-2*n)*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && SumSimplerQ[m,-2*n] && NonzeroQ[m+2*n*p+1] && 
...
FreeQ[{a1,b1,a2,b2,c,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[m] && m<-1 && 
  IntBinomialQ[a1*a2,b1*b2,c,n,m,p,x]
...
Int[(c_.*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  (c*x)^(m+1)*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1)/(a1*a2*c*(m+1)) - 
  b1*b2*(m+2*n*(p+1)+1)/(a1*a2*c^(2*n)*(m+1))*Int[(c*x)^(m+2*n)*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && SumSimplerQ[m,2*n] && 
  NegativeIntegerQ[Simplify[(m+1)/(2*n)+p]]
...
FreeQ[{a1,b1,a2,b2,c,p},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && FractionQ[m] && IntBinomialQ[a1*a2,b1*b2,c,n,m,p,x]
...
FreeQ[{a1,b1,a2,b2},x] && ZeroQ[a2*b1+a1*b2] && PositiveIntegerQ[2*n] && RationalQ[p] && -1<p<0 && p!=-1/2 && 
...
FreeQ[{a1,b1,a2,b2,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[2*n] && IntegerQ[m]
...
FreeQ[{a1,b1,a2,b2,c,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[2*n] && FractionQ[m]
...
FreeQ[{a1,b1,a2,b2,c,m,p},x] && ZeroQ[a2*b1+a1*b2] && NegativeIntegerQ[2*n] && Not[RationalQ[m]]
...
FreeQ[{a1,b1,a2,b2,m,p},x] && ZeroQ[a2*b1+a1*b2] && FractionQ[2*n]
...
Int[(c_*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  c^IntPart[m]*(c*x)^FracPart[m]/x^FracPart[m]*Int[x^m*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,p},x] && ZeroQ[a2*b1+a1*b2] && FractionQ[2*n]
...
FreeQ[{a1,b1,a2,b2,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[Simplify[2*n/(m+1)]] && Not[IntegerQ[2*n]]
...
Int[(c_*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  c^IntPart[m]*(c*x)^FracPart[m]/x^FracPart[m]*Int[x^m*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[Simplify[2*n/(m+1)]] && Not[IntegerQ[2*n]]
...
FreeQ[{a1,b1,a2,b2,m,n},x] && ZeroQ[a2*b1+a1*b2] && ZeroQ[(m+1)/(2*n)+p] && RationalQ[p] && p>0
...
Int[(c_*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  c^IntPart[m]*(c*x)^FracPart[m]/x^FracPart[m]*Int[x^m*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,n},x] && ZeroQ[a2*b1+a1*b2] && ZeroQ[(m+1)/(2*n)+p] && RationalQ[p] && p>0
...
Int[(c_.*x_)^m_.*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  (c*x)^(m+1)*(a1+b1*x^n)^p*(a2+b2*x^n)^p/(c*(m+2*n*p+1)) +
  2*a1*a2*n*p/(m+2*n*p+1)*Int[(c*x)^m*(a1+b1*x^n)^(p-1)*(a2+b2*x^n)^(p-1),x] /;
FreeQ[{a1,b1,a2,b2,c,m,n},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[p+Simplify[(m+1)/(2*n)]] && RationalQ[p] && p>0 && 
  NonzeroQ[m+2*n*p+1]
...
FreeQ[{a1,b1,a2,b2,m,n},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[p+Simplify[(m+1)/(2*n)]] && RationalQ[p] && -1<p<0
...
Int[(c_*x_)^m_*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  c^IntPart[m]*(c*x)^FracPart[m]/x^FracPart[m]*Int[x^m*(a1+b1*x^n)^p*(a2+b2*x^n)^p,x] /;
FreeQ[{a1,b1,a2,b2,c,m,n},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[p+Simplify[(m+1)/(2*n)]] && RationalQ[p] && -1<p<0
...
Int[(c_.*x_)^m_.*(a1_+b1_.*x_^n_)^p_*(a2_+b2_.*x_^n_)^p_,x_Symbol] :=
  -(c*x)^(m+1)*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1)/(2*a1*a2*c*n*(p+1)) +
  (m+2*n*(p+1)+1)/(2*a1*a2*n*(p+1))*Int[(c*x)^m*(a1+b1*x^n)^(p+1)*(a2+b2*x^n)^(p+1),x] /;
FreeQ[{a1,b1,a2,b2,c,m,n},x] && ZeroQ[a2*b1+a1*b2] && IntegerQ[p+Simplify[(m+1)/n]] && RationalQ[p] && p<-1
...
FreeQ[{a1,b1,a2,b2,c,m,n,p},x] && ZeroQ[a2*b1+a1*b2] && Not[IntegerQ[p]]
...
IntBinomialQ[a_,b_,c_,n_,m_,p_,x_] :=
  ...
  (ZeroQ[n-2] || ZeroQ[n-4]) && IntegersQ[2*m,4*p] || 
  ZeroQ[n-2] && IntegerQ[6*p] && (IntegerQ[m] || IntegerQ[m-p])
...
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[n*p+1] && IntegerQ[n]


Int[(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_.,x_Symbol] :=
  -x*(a+b*x^n)^(p+1)*(c+d*x^n)^q/(a*n*(p+1)) - 
  c*q/(a*(p+1))*Int[(a+b*x^n)^(p+1)*(c+d*x^n)^(q-1),x] /;
FreeQ[{a,b,c,d,n,p},x] && NonzeroQ[b*c-a*d] && ZeroQ[n*(p+q+1)+1] && RationalQ[q] && q>0 && NonzeroQ[p+1]
...
FreeQ[{a,b,c,d,n,p,q},x] && NonzeroQ[b*c-a*d] && ZeroQ[n*(p+q+2)+1] && ZeroQ[a*d*(p+1)+b*c*(q+1)]


(* Int[(a1_+b1_.*x_^n2_.)^p_*(a2_+b2_.*x_^n2_.)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  x*(a1+b1*x^(n/2))^(p+1)*(a2+b2*x^(n/2))^(p+1)*(c+d*x^n)^(q+1)/(a1*a2*c) /;
FreeQ[{a1,b1,a2,b2,c,d,n,p,q},x] && ZeroQ[n2-n/2] && ZeroQ[a2*b1+a1*b2] && ZeroQ[n*(p+q+2)+1] && ZeroQ[a1*a2*d*(p+1)+b1*b2*c*(q+1)] *)


Int[(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  -b*x*(a+b*x^n)^(p+1)*(c+d*x^n)^(q+1)/(a*n*(p+1)*(b*c-a*d)) + 
  (b*c+n*(p+1)*(b*c-a*d))/(a*n*(p+1)*(b*c-a*d))*Int[(a+b*x^n)^(p+1)*(c+d*x^n)^q,x] /;
FreeQ[{a,b,c,d,n,q},x] && NonzeroQ[b*c-a*d] && ZeroQ[n*(p+q+2)+1] && (RationalQ[p] && p<-1 || Not[RationalQ[q] && q<-1]) && NonzeroQ[p+1]
...
Int[1/((a_+b_.*x_^2)^(1/3)*(c_+d_.*x_^2)),x_Symbol] :=
  ...
  Sqrt[3]/(2*c)*Int[1/((a+b*x^2)^(1/3)*(Sqrt[3]+Rt[b/a,2]*x)),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[b*c+3*a*d] && PosQ[b/a]


Int[1/((a_+b_.*x_^2)^(1/3)*(c_+d_.*x_^2)),x_Symbol] :=
  1/6*Int[(3+Rt[-b/a,2]*x)/((a+b*x^2)^(1/3)*(c+d*x^2)),x] + 
  1/6*Int[(3-Rt[-b/a,2]*x)/((a+b*x^2)^(1/3)*(c+d*x^2)),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[b*c+3*a*d] && NegQ[b/a]


Int[(a_+b_.*x_^2)^(2/3)/(c_+d_.*x_^2),x_Symbol] :=
  b/d*Int[1/(a+b*x^2)^(1/3),x] - (b*c-a*d)/d*Int[1/((a+b*x^2)^(1/3)*(c+d*x^2)),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[b*c+3*a*d]
...
FreeQ[{a,b,c,d,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && p<-1 && 0<q<1 && IntBinomialQ[a,b,c,d,n,p,q,x]
...
FreeQ[{a,b,c,d,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && p<-1 && q>1 && IntBinomialQ[a,b,c,d,n,p,q,x]
...
FreeQ[{a,b,c,d,n,q},x] && NonzeroQ[b*c-a*d] && RationalQ[p] && p<-1 && Not[Not[IntegerQ[p]] && IntegerQ[q] && q<-1] && 
...
FreeQ[{a,b,c,d,n,p},x] && NonzeroQ[b*c-a*d] && RationalQ[q] && q>1 && NonzeroQ[n*(p+q)+1] && Not[IntegerQ[p] && p>1] && 
  IntBinomialQ[a,b,c,d,n,p,q,x]
...
FreeQ[{a,b,c,d,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && q>0 && p>0 && IntBinomialQ[a,b,c,d,n,p,q,x]
...
FreeQ[{a,b,c,d,n,p,q},x] && NonzeroQ[b*c-a*d] && NonzeroQ[n+1] && PositiveQ[a] && PositiveQ[c]


Int[(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  a^IntPart[p]*(a+b*x^n)^FracPart[p]/(1+b*x^n/a)^FracPart[p]*Int[(1+b*x^n/a)^p*(c+d*x^n)^q,x] /;
FreeQ[{a,b,c,d,n,p,q},x] && NonzeroQ[b*c-a*d] && NonzeroQ[n+1] && Not[PositiveQ[a]]
...
FreeQ[{a,b,c,d,n,p,q},x] && LinearQ[u,x] && NonzeroQ[u-x]
...
IntBinomialQ[a_,b_,c_,d_,n_,p_,q_,x_Symbol] :=
  ...
  (ZeroQ[n-2] || ZeroQ[n-4]) && (IntegersQ[p,4*q] || IntegersQ[4*p,q]) || 
  ZeroQ[n-2] && (IntegersQ[2*p,2*q] || IntegersQ[3*p,q] && ZeroQ[b*c+3*a*d] || IntegersQ[p,3*q] && ZeroQ[3*b*c+a*d])
...
FreeQ[{a1,b1,a2,b2,c,d,e,m,n,p},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2] && ZeroQ[a1*a2*d*(m+1)-b1*b2*c*(m+n*(p+1)+1)] && 
  NonzeroQ[m+1]


Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_.*(c_+d_.*x_^n_),x_Symbol] :=
  c*(e*x)^(m+1)*(a+b*x^n)^(p+1)/(a*e*(m+1)) + d/e^n*Int[(e*x)^(m+n)*(a+b*x^n)^p,x] /;
FreeQ[{a,b,c,d,e,p},x] && NonzeroQ[b*c-a*d] && ZeroQ[m+n*(p+1)+1] && (IntegerQ[n] || PositiveQ[e]) && 
...
FreeQ[{a1,b1,a2,b2,c,d,e,p},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2] && (IntegerQ[n] || PositiveQ[e]) && 
  RationalQ[m,n] && (n>0 && m<-1 || n<0 && m+n>-1) && Not[IntegerQ[p] && p<-1]
...
FreeQ[{a1,b1,a2,b2,c,d,e,m,n},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2] && RationalQ[p] && p<-1 && 
  (IntegerQ[p] || Not[RationalQ[m]] || PositiveIntegerQ[n] && NegativeIntegerQ[p+1/2] && -1<=m<=-n*(p+1))
...
FreeQ[{a1,b1,a2,b2,c,d,e,m,n,p},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2] && NonzeroQ[m+n*(p+1)+1]
...
FreeQ[{a,b,c,d,e,m,p},x] && NonzeroQ[b*c-a*d] && PositiveIntegerQ[n] && RationalQ[q] && q>1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]
...
FreeQ[{a,b,c,d,e,p,q},x] && NonzeroQ[b*c-a*d] && PositiveIntegerQ[n] && RationalQ[m] && m<-1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]
...
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && IntegersQ[m/2,n/2] && 0<m-n+1<n && n<=4
...
Int[x_/((a_+b_.*x_^3)*Sqrt[c_+d_.*x_^3]),x_Symbol] :=
  ...
  q*Log[1-2^(1/3)*q*x+Sqrt[c+d*x^3]/Sqrt[c]]/(6*2^(2/3)*b*Sqrt[c])] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[4*b*c-a*d]


Int[x_^m_/((a_+b_.*x_^3)*Sqrt[c_+d_.*x_^3]),x_Symbol] :=
  1/b*Int[x^(m-3)/Sqrt[c+d*x^3],x] - a/b*Int[x^(m-3)/((a+b*x^3)*Sqrt[c+d*x^3]),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[4*b*c-a*d] && PositiveIntegerQ[(m-1)/3]


Int[x_^m_/((a_+b_.*x_^3)*Sqrt[c_+d_.*x_^3]),x_Symbol] :=
  1/a*Int[x^m/Sqrt[c+d*x^3],x] - b/a*Int[x^(m+3)/((a+b*x^3)*Sqrt[c+d*x^3]),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[4*b*c-a*d] && NegativeIntegerQ[(m-1)/3]
...
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && ZeroQ[4*b*c-a*d] && IntegerQ[(m-1)/3]


Int[x_^2/(Sqrt[a_+b_.*x_^2]*Sqrt[c_+d_.*x_^2]),x_Symbol] :=
  x*Sqrt[a+b*x^2]/(b*Sqrt[c+d*x^2]) - c/b*Int[Sqrt[a+b*x^2]/(c+d*x^2)^(3/2),x] /;
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && PosQ[b/a] && PosQ[d/c] && Not[SimplerSqrtQ[b/a,d/c]]
...
FreeQ[{a,b,c,d},x] && NonzeroQ[b*c-a*d] && (EqQ[n,2] || EqQ[n,4]) && Not[EqQ[n,2] && SimplerSqrtQ[-b/a,-d/c]]
...
Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  ...
  1/(a*b*n*(p+1))*Int[(e*x)^m*(a+b*x^n)^(p+1)*(c+d*x^n)^(q-2)*
    Simp[c*(c*b*n*(p+1)+(c*b-a*d)*(m+1))+d*(c*b*n*(p+1)+(c*b-a*d)*(m+n*(q-1)+1))*x^n,x],x] /;
FreeQ[{a,b,c,d,e,m,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && p<-1 && q>1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]


Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  -(e*x)^(m+1)*(a+b*x^n)^(p+1)*(c+d*x^n)^q/(a*e*n*(p+1)) + 
  1/(a*n*(p+1))*Int[(e*x)^m*(a+b*x^n)^(p+1)*(c+d*x^n)^(q-1)*Simp[c*(m+n*(p+1)+1)+d*(m+n*(p+q+1)+1)*x^n,x],x] /;
FreeQ[{a,b,c,d,e,m,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && p<-1 && 0<q<1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]
...
Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  ...
  1/(a*n*(b*c-a*d)*(p+1))*
    Int[(e*x)^m*(a+b*x^n)^(p+1)*(c+d*x^n)^q*Simp[c*b*(m+1)+n*(b*c-a*d)*(p+1)+d*b*(m+n*(p+q+2)+1)*x^n,x],x] /;
FreeQ[{a,b,c,d,e,m,n,q},x] && NonzeroQ[b*c-a*d] && RationalQ[p] && p<-1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]


Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  (e*x)^(m+1)*(a+b*x^n)^p*(c+d*x^n)^q/(e*(m+n*(p+q)+1)) + 
  n/(m+n*(p+q)+1)*Int[(e*x)^m*(a+b*x^n)^(p-1)*(c+d*x^n)^(q-1)*Simp[a*c*(p+q)+(q*(b*c-a*d)+a*d*(p+q))*x^n,x],x] /;
FreeQ[{a,b,c,d,e,m,n},x] && NonzeroQ[b*c-a*d] && RationalQ[p,q] && q>0 && p>0 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]
...
Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  ...
  1/(b*(m+n*(p+q)+1))*Int[(e*x)^m*(a+b*x^n)^p*(c+d*x^n)^(q-2)*
    Simp[c*((c*b-a*d)*(m+1)+c*b*n*(p+q))+(d*(c*b-a*d)*(m+1)+d*n*(q-1)*(b*c-a*d)+c*b*d*n*(p+q))*x^n,x],x] /;
FreeQ[{a,b,c,d,e,m,n,p},x] && NonzeroQ[b*c-a*d] && RationalQ[q] && q>1 && IntBinomialQ[a,b,c,d,e,m,n,p,q,x]
...
FreeQ[{a,b,c,d,e,m,n,p,q},x] && NonzeroQ[b*c-a*d] && NonzeroQ[m+1] && NonzeroQ[m-n+1] && PositiveQ[a] && PositiveQ[c]


Int[(e_.*x_)^m_.*(a_+b_.*x_^n_)^p_*(c_+d_.*x_^n_)^q_,x_Symbol] :=
  a^IntPart[p]*(a+b*x^n)^FracPart[p]/(1+b*x^n/a)^FracPart[p]*Int[(e*x)^m*(1+b*x^n/a)^p*(c+d*x^n)^q,x] /;
FreeQ[{a,b,c,d,e,m,n,p,q},x] && NonzeroQ[b*c-a*d] && NonzeroQ[m+1] && NonzeroQ[m-n+1] && Not[PositiveQ[a]]
...
FreeQ[{a,b,c,d,n,p,q},x] && LinearQ[v,x] && IntegerQ[m] && NonzeroQ[v-x]
...
IntBinomialQ[a_,b_,c_,d_,e_,m_,n_,p_,q_,x_Symbol] :=
  IntegersQ[p,q] || PositiveIntegerQ[p] || PositiveIntegerQ[q] || 
  ZeroQ[n-2] && IntegerQ[m] && IntegersQ[2*p,2*q] || 
  ZeroQ[n-4] && (IntegersQ[m,p,2*q] || IntegersQ[m,2*p,q])


Int[u_.*(a1_+b1_.*x_^non2_.)^p_.*(a2_+b2_.*x_^non2_.)^p_.*(c_+d_.*x_^n_.)^q_.,x_Symbol] :=
  Int[u*(a1*a2+b1*b2*x^n)^p*(c+d*x^n)^q,x] /;
FreeQ[{a1,b1,a2,b2,c,d,n,p,q},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2] && (IntegerQ[p] || PositiveQ[a1] && PositiveQ[a2])
...
FreeQ[{a1,b1,a2,b2,c,d,e,n,p,q},x] && ZeroQ[non2-n/2] && ZeroQ[n2-2*n] && ZeroQ[a2*b1+a1*b2] && 
...
Int[u_.*(a1_+b1_.*x_^non2_.)^p_*(a2_+b2_.*x_^non2_.)^p_*(c_+d_.*x_^n_.)^q_.,x_Symbol] :=
  (a1+b1*x^(n/2))^FracPart[p]*(a2+b2*x^(n/2))^FracPart[p]/(a1*a2+b1*b2*x^n)^FracPart[p]*
    Int[u*(a1*a2+b1*b2*x^n)^p*(c+d*x^n)^q,x] /;
FreeQ[{a1,b1,a2,b2,c,d,n,p,q},x] && ZeroQ[non2-n/2] && ZeroQ[a2*b1+a1*b2]
...
FreeQ[{a,b,c,d,e,f,n},x] && 
  Not[ZeroQ[n-2] && (PosQ[b/a] && PosQ[d/c] || NegQ[b/a] && (PosQ[d/c] || PositiveQ[a] && (Not[PositiveQ[c]] || SimplerSqrtQ[-b/a,-d/c])))]
...
FreeQ[{a,b,c,d,e,f,n,p},x] && RationalQ[q] && q>0 && NonzeroQ[n*(p+q+1)+1]
...
FreeQ[{a,b,c,d,e1,f1,e2,f2,n,p,q,r},x] && ZeroQ[n2-n/2] && ZeroQ[e2*f1+e1*f2] && (IntegerQ[r] || PositiveQ[e1] && PositiveQ[e2])


Int[(a_+b_.*x_^n_)^p_.*(c_+d_.*x_^n_)^q_.*(e1_+f1_.*x_^n2_.)^r_.*(e2_+f2_.*x_^n2_.)^r_.,x_Symbol] :=
  (e1+f1*x^(n/2))^FracPart[r]*(e2+f2*x^(n/2))^FracPart[r]/(e1*e2+f1*f2*x^n)^FracPart[r]*
    Int[(a+b*x^n)^p*(c+d*x^n)^q*(e1*e2+f1*f2*x^n)^r,x] /;
FreeQ[{a,b,c,d,e1,f1,e2,f2,n,p,q,r},x] && ZeroQ[n2-n/2] && ZeroQ[e2*f1+e1*f2]
...
FreeQ[{a,b,c,d,e1,f1,e2,f2,g,m,n,p,q,r},x] && ZeroQ[n2-n/2] && ZeroQ[e2*f1+e1*f2] && (IntegerQ[r] || PositiveQ[e1] && PositiveQ[e2])


Int[(g_.*x_)^m_.*(a_+b_.*x_^n_)^p_.*(c_+d_.*x_^n_)^q_.*(e1_+f1_.*x_^n2_.)^r_.*(e2_+f2_.*x_^n2_.)^r_.,x_Symbol] :=
  (e1+f1*x^(n/2))^FracPart[r]*(e2+f2*x^(n/2))^FracPart[r]/(e1*e2+f1*f2*x^n)^FracPart[r]*
    Int[(g*x)^m*(a+b*x^n)^p*(c+d*x^n)^q*(e1*e2+f1*f2*x^n)^r,x] /;
FreeQ[{a,b,c,d,e1,f1,e2,f2,g,m,n,p,q,r},x] && ZeroQ[n2-n/2] && ZeroQ[e2*f1+e1*f2]
