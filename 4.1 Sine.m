...
FreeQ[{a,b,e,f,g,m,p},x] && NonzeroQ[a^2-b^2]


Int[(g_.*cot[e_.+f_.*x_])^p_.*(a_+b_.*cos[e_.+f_.*x_])^m_.,x_Symbol] :=
  Defer[Int][(g*Cot[e+f*x])^p*(a+b*Cos[e+f*x])^m,x] /;
FreeQ[{a,b,e,f,g,m,p},x] && NonzeroQ[a^2-b^2]
...
Int[Sqrt[d_.*sin[e_.+f_.*x_]]/(Sqrt[cos[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  4*Sqrt[2]*d/f*Subst[Int[x^2/((a*d^2+2*b*d*x^2+a*x^4)*Sqrt[1-x^4/d^2]),x],x,Sqrt[d*Sin[e+f*x]]/Sqrt[1+Cos[e+f*x]]] /;
FreeQ[{a,b,d,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[d_.*cos[e_.+f_.*x_]]/(Sqrt[sin[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  -4*Sqrt[2]*d/f*Subst[Int[x^2/((a*d^2+2*b*d*x^2+a*x^4)*Sqrt[1-x^4/d^2]),x],x,Sqrt[d*Cos[e+f*x]]/Sqrt[1+Sin[e+f*x]]] /;
FreeQ[{a,b,d,e,f},x] && NonzeroQ[a^2-b^2]
...
Int[(c_.+d_.*x_)^m_.*(a_.+b_.*Cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  Defer[Int][(c+d*x)^m*(a+b*Cos[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,m,n},x]
