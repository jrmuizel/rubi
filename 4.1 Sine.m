...
(* Int[(b_.*sin[c_.+d_.*x_])^n_,x_Symbol] :=
  Cos[c+d*x]/(d*Sqrt[Cos[c+d*x]^2])*Subst[Int[(b*x)^n/Sqrt[1-x^2],x],x,Sin[c+d*x]] /;
FreeQ[{b,c,d,n},x] && Not[IntegerQ[2*n]] *)


(* Int[(b_.*cos[c_.+d_.*x_])^n_,x_Symbol] :=
  -Sin[c+d*x]/(d*Sqrt[Sin[c+d*x]^2])*Subst[Int[(b*x)^n/Sqrt[1-x^2],x],x,Cos[c+d*x]] /;
FreeQ[{b,c,d,n},x] && Not[IntegerQ[2*n]] *)
...
Int[(b_.*sin[c_.+d_.*x_]^2)^n_,x_Symbol] :=
  -Cot[c+d*x]*(b*Sin[c+d*x]^2)^n/(2*d*n) + 
  b*(2*n-1)/(2*n)*Int[(b*Sin[c+d*x]^2)^(n-1),x] /;
FreeQ[{b,c,d},x] && RationalQ[n] && n>1


Int[(b_.*cos[c_.+d_.*x_]^2)^n_,x_Symbol] :=
  Tan[c+d*x]*(b*Cos[c+d*x]^2)^n/(2*d*n) + 
  b*(2*n-1)/(2*n)*Int[(b*Cos[c+d*x]^2)^(n-1),x] /;
FreeQ[{b,c,d},x] && RationalQ[n] && n>1


Int[(b_.*sin[c_.+d_.*x_]^2)^n_,x_Symbol] :=
  Cot[c+d*x]*(b*Sin[c+d*x]^2)^(n+1)/(d*b*(2*n+1)) + 
  2*(n+1)/(b*(2*n+1))*Int[(b*Sin[c+d*x]^2)^(n+1),x] /;
FreeQ[{b,c,d},x] && RationalQ[n] && n<-1


Int[(b_.*cos[c_.+d_.*x_]^2)^n_,x_Symbol] :=
  -Tan[c+d*x]*(b*Cos[c+d*x]^2)^(n+1)/(d*b*(2*n+1)) + 
  2*(n+1)/(b*(2*n+1))*Int[(b*Cos[c+d*x]^2)^(n+1),x] /;
FreeQ[{b,c,d},x] && RationalQ[n] && n<-1
...
(* ::Subsection::Closed:: *)
(*1.0.2 (b sin)^m (d cos)^n*)


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  (b*Sin[e+f*x])^(m+1)*(d*Cos[e+f*x])^(n+1)/(f*b*d*(m+1)) /;
FreeQ[{b,e,f,d,m,n},x] && ZeroQ[m+n+2] && NonzeroQ[m+1]


Int[(b_.*sin[e_.+f_.*x_])^m_.*cos[e_.+f_.*x_]^n_.,x_Symbol] :=
  1/f*Subst[Int[(b*x)^m*(1-x^2)^((n-1)/2),x],x,Sin[e+f*x]] /;
FreeQ[{b,e,f,m},x] && IntegerQ[(n-1)/2] && Not[IntegerQ[(m-1)/2] && 0<m<n]


Int[sin[e_.+f_.*x_]^m_.*(d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  -1/f*Subst[Int[(d*x)^n*(1-x^2)^((m-1)/2),x],x,Cos[e+f*x]] /;
FreeQ[{e,f,d,n},x] && IntegerQ[(m-1)/2] && Not[IntegerQ[(n-1)/2] && 0<n<=m]


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  -b*(b*Sin[e+f*x])^(m-1)*(d*Cos[e+f*x])^(n+1)/(f*d*(n+1)) + 
  b^2*(m-1)/(d^2*(n+1))*Int[(b*Sin[e+f*x])^(m-2)*(d*Cos[e+f*x])^(n+2),x] /;
FreeQ[{b,e,f,d},x] && RationalQ[m,n] && m>1 && n<-1


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  d*(b*Sin[e+f*x])^(m+1)*(d*Cos[e+f*x])^(n-1)/(f*b*(m+1)) + 
  d^2*(n-1)/(b^2*(m+1))*Int[(b*Sin[e+f*x])^(m+2)*(d*Cos[e+f*x])^(n-2),x] /;
FreeQ[{b,e,f,d},x] && RationalQ[m,n] && m<-1 && n>1


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  -b*(b*Sin[e+f*x])^(m-1)*(d*Cos[e+f*x])^(n+1)/(f*d*(m+n)) + 
  b^2*(m-1)/(m+n)*Int[(b*Sin[e+f*x])^(m-2)*(d*Cos[e+f*x])^n,x] /;
FreeQ[{b,e,f,d,n},x] && RationalQ[m] && m>1 && NonzeroQ[m+n] && RationalQ[n]


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  d*(b*Sin[e+f*x])^(m+1)*(d*Cos[e+f*x])^(n-1)/(f*b*(m+n)) + 
  d^2*(n-1)/(m+n)*Int[(b*Sin[e+f*x])^m*(d*Cos[e+f*x])^(n-2),x] /;
FreeQ[{b,e,f,d,m},x] && RationalQ[n] && n>1 && NonzeroQ[m+n] && RationalQ[m]


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  (b*Sin[e+f*x])^(m+1)*(d*Cos[e+f*x])^(n+1)/(f*b*d*(m+1)) + 
  (m+n+2)/(b^2*(m+1))*Int[(b*Sin[e+f*x])^(m+2)*(d*Cos[e+f*x])^n,x] /;
FreeQ[{b,e,f,d,n},x] && RationalQ[m] && m<-1 && NonzeroQ[m+n+2] && RationalQ[n]


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  -(b*Sin[e+f*x])^(m+1)*(d*Cos[e+f*x])^(n+1)/(f*b*d*(n+1)) + 
  (m+n+2)/(d^2*(n+1))*Int[(b*Sin[e+f*x])^m*(d*Cos[e+f*x])^(n+2),x] /;
FreeQ[{b,e,f,d,m},x] && RationalQ[n] && n<-1 && NonzeroQ[m+n+2] && RationalQ[m]


Int[Sqrt[b_.*sin[e_.+f_.*x_]]*Sqrt[d_.*cos[e_.+f_.*x_]],x_Symbol] :=
  Sqrt[b*Sin[e+f*x]]*Sqrt[d*Cos[e+f*x]]/Sqrt[Sin[2*e+2*f*x]]*Int[Sqrt[Sin[2*e+2*f*x]],x] /;
FreeQ[{b,e,f,d},x]


Int[1/(Sqrt[b_.*sin[e_.+f_.*x_]]*Sqrt[d_.*cos[e_.+f_.*x_]]),x_Symbol] :=
  Sqrt[Sin[2*e+2*f*x]]/(Sqrt[b*Sin[e+f*x]]*Sqrt[d*Cos[e+f*x]])*Int[1/Sqrt[Sin[2*e+2*f*x]],x] /;
FreeQ[{b,e,f,d},x]


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  Module[{k=Denominator[m]},
  k*b*d/f*Subst[Int[x^(k*(m+1)-1)/(b^2+d^2*x^(2*k)),x],x,(b*Sin[e+f*x])^(1/k)/(d*Cos[e+f*x])^(1/k)]] /;
FreeQ[{b,e,f,d},x] && ZeroQ[m+n] && RationalQ[m] && 0<m<1


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  Module[{k=Denominator[m]},
  -k*b*d/f*Subst[Int[x^(k*(n+1)-1)/(d^2+b^2*x^(2*k)),x],x,(d*Cos[e+f*x])^(1/k)/(b*Sin[e+f*x])^(1/k)]] /;
FreeQ[{b,e,f,d},x] && ZeroQ[m+n] && RationalQ[m] && -1<m<0


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  d^(2*IntPart[(n-1)/2]+1)*(d*Cos[e+f*x])^(2*FracPart[(n-1)/2])/(f*(Cos[e+f*x]^2)^FracPart[(n-1)/2])*
    Subst[Int[(b*x)^m*(1-x^2)^((n-1)/2),x],x,Sin[e+f*x]] /;
FreeQ[{b,d,e,f,m,n},x] && (RationalQ[n] || Not[RationalQ[m]] && (ZeroQ[d-1] || NonzeroQ[b-1]))


Int[(b_.*sin[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  -b^(2*IntPart[(m-1)/2]+1)*(b*Sin[e+f*x])^(2*FracPart[(m-1)/2])/(f*(Sin[e+f*x]^2)^FracPart[(m-1)/2])*
    Subst[Int[(d*x)^n*(1-x^2)^((m-1)/2),x],x,Cos[e+f*x]] /;
FreeQ[{b,d,e,f,m,n},x]
...
Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)/(c*f*(p+1)) + a*Int[(c*Cos[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && Not[IntegerQ[(p-1)/2]] && (IntegerQ[2*p] || NonzeroQ[a^2-b^2])


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)/(c*f*(p+1)) + a*Int[(c*Sin[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && Not[IntegerQ[(p-1)/2]] && (IntegerQ[2*p] || NonzeroQ[a^2-b^2])


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  (a/c)^(2*m)*Int[(c*Cos[e+f*x])^(2*m+p)/(a-b*Sin[e+f*x])^m,x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && IntegerQ[m] && RationalQ[p] && p<-1 && 2*m+p>=0


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  (a/c)^(2*m)*Int[(c*Sin[e+f*x])^(2*m+p)/(a-b*Cos[e+f*x])^m,x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && IntegerQ[m] && RationalQ[p] && p<-1 && 2*m+p>=0


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m/(a*c*f*m) /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && ZeroQ[Simplify[m+p+1]] && Not[NegativeIntegerQ[p]]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m/(a*c*f*m) /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && ZeroQ[Simplify[m+p+1]] && Not[NegativeIntegerQ[p]]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m/(a*c*f*Simplify[2*m+p+1]) + 
  Simplify[m+p+1]/(a*Simplify[2*m+p+1])*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && NegativeIntegerQ[Simplify[m+p+1]] && NonzeroQ[2*m+p+1] && Not[PositiveIntegerQ[m]]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m/(a*c*f*Simplify[2*m+p+1]) + 
  Simplify[m+p+1]/(a*Simplify[2*m+p+1])*Int[(c*Sin[e+f*x])^p*(a+b*Cos[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && NegativeIntegerQ[Simplify[m+p+1]] && NonzeroQ[2*m+p+1] && Not[PositiveIntegerQ[m]]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)/(c*f*(m-1)) /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && ZeroQ[2*m+p-1] && NonzeroQ[m-1]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m-1)/(c*f*(m-1)) /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && ZeroQ[2*m+p-1] && NonzeroQ[m-1]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)/(c*f*(m+p)) + 
  a*(2*m+p-1)/(m+p)*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m-1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && PositiveIntegerQ[Simplify[(2*m+p-1)/2]] && NonzeroQ[m+p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m-1)/(c*f*(m+p)) + 
  a*(2*m+p-1)/(m+p)*Int[(c*Sin[e+f*x])^p*(a+b*Cos[e+f*x])^(m-1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && PositiveIntegerQ[Simplify[(2*m+p-1)/2]] && NonzeroQ[m+p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m/(a*c*f*(p+1)) + 
  a*(m+p+1)/(c^2*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^(m-1),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m>0 && p<=-2*m && IntegersQ[m+1/2,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m/(a*c*f*(p+1)) + 
  a*(m+p+1)/(c^2*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^(m-1),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m>0 && p<=-2*m && IntegersQ[m+1/2,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -2*b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)/(c*f*(p+1)) + 
  b^2*(2*m+p-1)/(c^2*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^(m-2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m>1 && p<-1 && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  2*b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m-1)/(c*f*(p+1)) + 
  b^2*(2*m+p-1)/(c^2*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^(m-2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m>1 && p<-1 && IntegersQ[2*m,2*p]


Int[Sqrt[a_+b_.*sin[e_.+f_.*x_]]/Sqrt[c_.*cos[e_.+f_.*x_]],x_Symbol] :=
  a*Sqrt[1+Cos[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(a+a*Cos[e+f*x]+b*Sin[e+f*x])*Int[Sqrt[1+Cos[e+f*x]]/Sqrt[c*Cos[e+f*x]],x] + 
  b*Sqrt[1+Cos[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(a+a*Cos[e+f*x]+b*Sin[e+f*x])*Int[Sin[e+f*x]/(Sqrt[c*Cos[e+f*x]]*Sqrt[1+Cos[e+f*x]]),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]


Int[Sqrt[a_+b_.*cos[e_.+f_.*x_]]/Sqrt[c_.*sin[e_.+f_.*x_]],x_Symbol] :=
  a*Sqrt[1+Sin[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(a+a*Sin[e+f*x]+b*Cos[e+f*x])*Int[Sqrt[1+Sin[e+f*x]]/Sqrt[c*Sin[e+f*x]],x] + 
  b*Sqrt[1+Sin[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(a+a*Sin[e+f*x]+b*Cos[e+f*x])*Int[Cos[e+f*x]/(Sqrt[c*Sin[e+f*x]]*Sqrt[1+Sin[e+f*x]]),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]
...
Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)/(c*f*(m+p)) + 
  a*(2*m+p-1)/(m+p)*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m-1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && RationalQ[m] && m>0 && NonzeroQ[m+p] && IntegersQ[2*m,2*p]
...
Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)*(a+b*Sin[e+f*x])^(m+1)/(b*f*(m+p)) + 
  c^2*(p-1)/(a*(m+p))*Int[(c*Cos[e+f*x])^(p-2)*(a+b*Sin[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m<-1 && p>1 && (m>-2 || ZeroQ[2*m+p+1] || m==-2 && IntegerQ[p]) && 
  NonzeroQ[m+p] && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)*(a+b*Cos[e+f*x])^(m+1)/(b*f*(m+p)) + 
  c^2*(p-1)/(a*(m+p))*Int[(c*Sin[e+f*x])^(p-2)*(a+b*Cos[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m<-1 && p>1 && (m>-2 || ZeroQ[2*m+p+1] || m==-2 && IntegerQ[p]) && 
  NonzeroQ[m+p] && IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  2*c*(c*Cos[e+f*x])^(p-1)*(a+b*Sin[e+f*x])^(m+1)/(b*f*(2*m+p+1)) + 
  c^2*(p-1)/(b^2*(2*m+p+1))*Int[(c*Cos[e+f*x])^(p-2)*(a+b*Sin[e+f*x])^(m+2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m<=-2 && p>1 && NonzeroQ[2*m+p+1] && Not[NegativeIntegerQ[m+p+1]] && 
  IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -2*c*(c*Sin[e+f*x])^(p-1)*(a+b*Cos[e+f*x])^(m+1)/(b*f*(2*m+p+1)) + 
  c^2*(p-1)/(b^2*(2*m+p+1))*Int[(c*Sin[e+f*x])^(p-2)*(a+b*Cos[e+f*x])^(m+2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[m,p] && m<=-2 && p>1 && NonzeroQ[2*m+p+1] && Not[NegativeIntegerQ[m+p+1]] && 
  IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m/(a*c*f*(2*m+p+1)) + 
  (m+p+1)/(a*(2*m+p+1))*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && RationalQ[m] && m<-1 && NonzeroQ[2*m+p+1] && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m/(a*c*f*(2*m+p+1)) + 
  (m+p+1)/(a*(2*m+p+1))*Int[(c*Sin[e+f*x])^p*(a+b*Cos[e+f*x])^(m+1),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && RationalQ[m] && m<-1 && NonzeroQ[2*m+p+1] && IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_/(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)/(b*f*(p-1)) + c^2/a*Int[(c*Cos[e+f*x])^(p-2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p>1 && IntegerQ[2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_/(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)/(b*f*(p-1)) + c^2/a*Int[(c*Sin[e+f*x])^(p-2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p>1 && IntegerQ[2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_/(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  b*(c*Cos[e+f*x])^(p+1)/(a*c*f*(p-1)*(a+b*Sin[e+f*x])) + 
  p/(a*(p-1))*Int[(c*Cos[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && ZeroQ[a^2-b^2] && Not[RationalQ[p] && p>=1] && IntegerQ[2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_/(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  -b*(c*Sin[e+f*x])^(p+1)/(a*c*f*(p-1)*(a+b*Cos[e+f*x])) + 
  p/(a*(p-1))*Int[(c*Sin[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && ZeroQ[a^2-b^2] && Not[RationalQ[p] && p>=1] && IntegerQ[2*p]


Int[Sqrt[c_.*cos[e_.+f_.*x_]]/Sqrt[a_+b_.*sin[e_.+f_.*x_]],x_Symbol] :=
  c*Sqrt[1+Cos[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(a+a*Cos[e+f*x]+b*Sin[e+f*x])*Int[Sqrt[1+Cos[e+f*x]]/Sqrt[c*Cos[e+f*x]],x] - 
  c*Sqrt[1+Cos[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(b+b*Cos[e+f*x]+a*Sin[e+f*x])*Int[Sin[e+f*x]/(Sqrt[c*Cos[e+f*x]]*Sqrt[1+Cos[e+f*x]]),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]


Int[Sqrt[c_.*sin[e_.+f_.*x_]]/Sqrt[a_+b_.*cos[e_.+f_.*x_]],x_Symbol] :=
  c*Sqrt[1+Sin[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(a+a*Sin[e+f*x]+b*Cos[e+f*x])*Int[Sqrt[1+Sin[e+f*x]]/Sqrt[c*Sin[e+f*x]],x] - 
  c*Sqrt[1+Sin[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(b+b*Sin[e+f*x]+a*Cos[e+f*x])*Int[Cos[e+f*x]/(Sqrt[c*Sin[e+f*x]]*Sqrt[1+Sin[e+f*x]]),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]


Int[(c_.*cos[e_.+f_.*x_])^(3/2)/Sqrt[a_+b_.*sin[e_.+f_.*x_]],x_Symbol] :=
  c*Sqrt[c*Cos[e+f*x]]*Sqrt[a+b*Sin[e+f*x]]/(b*f) + 
  c^2/(2*a)*Int[Sqrt[a+b*Sin[e+f*x]]/Sqrt[c*Cos[e+f*x]],x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]


Int[(c_.*sin[e_.+f_.*x_])^(3/2)/Sqrt[a_+b_.*cos[e_.+f_.*x_]],x_Symbol] :=
  -c*Sqrt[c*Sin[e+f*x]]*Sqrt[a+b*Cos[e+f*x]]/(b*f) + 
  c^2/(2*a)*Int[Sqrt[a+b*Cos[e+f*x]]/Sqrt[c*Sin[e+f*x]],x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2]


Int[(c_.*cos[e_.+f_.*x_])^p_/Sqrt[a_+b_.*sin[e_.+f_.*x_]],x_Symbol] :=
  -2*b*(c*Cos[e+f*x])^(p+1)/(c*f*(2*p-1)*(a+b*Sin[e+f*x])^(3/2)) + 
  2*a*(p-2)/(2*p-1)*Int[(c*Cos[e+f*x])^p/(a+b*Sin[e+f*x])^(3/2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p>2 && IntegerQ[2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_/Sqrt[a_+b_.*cos[e_.+f_.*x_]],x_Symbol] :=
  2*b*(c*Sin[e+f*x])^(p+1)/(c*f*(2*p-1)*(a+b*Cos[e+f*x])^(3/2)) + 
  2*a*(p-2)/(2*p-1)*Int[(c*Sin[e+f*x])^p/(a+b*Cos[e+f*x])^(3/2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p>2 && IntegerQ[2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_/Sqrt[a_+b_.*sin[e_.+f_.*x_]],x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)/(a*c*f*(p+1)*Sqrt[a+b*Sin[e+f*x]]) + 
  a*(2*p+1)/(2*c^2*(p+1))*Int[(c*Cos[e+f*x])^(p+2)/(a+b*Sin[e+f*x])^(3/2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p<-1 && IntegerQ[2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_/Sqrt[a_+b_.*cos[e_.+f_.*x_]],x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)/(a*c*f*(p+1)*Sqrt[a+b*Cos[e+f*x]]) + 
  a*(2*p+1)/(2*c^2*(p+1))*Int[(c*Sin[e+f*x])^(p+2)/(a+b*Cos[e+f*x])^(3/2),x] /;
FreeQ[{a,b,c,e,f},x] && ZeroQ[a^2-b^2] && RationalQ[p] && p<-1 && IntegerQ[2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_.,x_Symbol] :=
  a^m*(c*Cos[e+f*x])^(p+1)/(c*f*(1+Sin[e+f*x])^((p+1)/2)*(1-Sin[e+f*x])^((p+1)/2))*
    Subst[Int[(1+b/a*x)^(m+(p-1)/2)*(1-b/a*x)^((p-1)/2),x],x,Sin[e+f*x]] /;
FreeQ[{a,b,c,e,f,p},x] && ZeroQ[a^2-b^2] && IntegerQ[m]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_.,x_Symbol] :=
  -a^m*(c*Sin[e+f*x])^(p+1)/(c*f*(1+Cos[e+f*x])^((p+1)/2)*(1-Cos[e+f*x])^((p+1)/2))*
    Subst[Int[(1+b/a*x)^(m+(p-1)/2)*(1-b/a*x)^((p-1)/2),x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,e,f,p},x] && ZeroQ[a^2-b^2] && IntegerQ[m]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_.,x_Symbol] :=
  a^2*(c*Cos[e+f*x])^(p+1)/(c*f*(a+b*Sin[e+f*x])^((p+1)/2)*(a-b*Sin[e+f*x])^((p+1)/2))*
    Subst[Int[(a+b*x)^(m+(p-1)/2)*(a-b*x)^((p-1)/2),x],x,Sin[e+f*x]] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && Not[IntegerQ[m]]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_.,x_Symbol] :=
  -a^2*(c*Sin[e+f*x])^(p+1)/(c*f*(a+b*Cos[e+f*x])^((p+1)/2)*(a-b*Cos[e+f*x])^((p+1)/2))*
    Subst[Int[(a+b*x)^(m+(p-1)/2)*(a-b*x)^((p-1)/2),x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,e,f,m,p},x] && ZeroQ[a^2-b^2] && Not[IntegerQ[m]]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  a*Int[(c*Cos[e+f*x])^p,x] + b*Int[Sin[e+f*x]*(c*Cos[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && IntegerQ[2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  a*Int[(c*Sin[e+f*x])^p,x] + b*Int[Cos[e+f*x]*(c*Sin[e+f*x])^p,x] /;
FreeQ[{a,b,c,e,f,p},x] && IntegerQ[2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^m*Sin[e+f*x]/(c*f*(p+1)) + 
  1/(c^2*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^(m-1)*(a*(p+2)+b*(m+p+2)*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && 0<m<1 && p<-1 && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  (c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^m*Cos[e+f*x]/(c*f*(p+1)) + 
  1/(c^2*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^(m-1)*(a*(p+2)+b*(m+p+2)*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && 0<m<1 && p<-1 && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)*(b+a*Sin[e+f*x])/(c*f*(p+1)) + 
  1/(c^2*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^(m-2)*(b^2*(m-1)+a^2*(p+2)+a*b*(m+p+1)*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && m>1 && p<-1 && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  (c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m-1)*(b+a*Cos[e+f*x])/(c*f*(p+1)) + 
  1/(c^2*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^(m-2)*(b^2*(m-1)+a^2*(p+2)+a*b*(m+p+1)*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && m>1 && p<-1 && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m-1)/(c*f*(m+p)) + 
  1/(m+p)*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m-2)*(b^2*(m-1)+a^2*(m+p)+a*b*(2*m+p-1)*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,p},x] && NonzeroQ[a^2-b^2] && RationalQ[m] && m>1 && NonzeroQ[m+p] && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m-1)/(c*f*(m+p)) + 
  1/(m+p)*Int[(c*Sin[e+f*x])^p*(a+b*Cos[e+f*x])^(m-2)*(b^2*(m-1)+a^2*(m+p)+a*b*(2*m+p-1)*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,p},x] && NonzeroQ[a^2-b^2] && RationalQ[m] && m>1 && NonzeroQ[m+p] && (IntegersQ[2*m,2*p] || IntegerQ[m])


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)*(a+b*Sin[e+f*x])^(m+1)/(b*f*(m+1)) + 
  c^2*(p-1)/(b*(m+1))*Int[(c*Cos[e+f*x])^(p-2)*(a+b*Sin[e+f*x])^(m+1)*Sin[e+f*x],x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && m<-1 && p>1 && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)*(a+b*Cos[e+f*x])^(m+1)/(b*f*(m+1)) + 
  c^2*(p-1)/(b*(m+1))*Int[(c*Sin[e+f*x])^(p-2)*(a+b*Cos[e+f*x])^(m+1)*Cos[e+f*x],x] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[m,p] && m<-1 && p>1 && IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  -b*(c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m+1)/(c*f*(a^2-b^2)*(m+1)) + 
  1/((a^2-b^2)*(m+1))*Int[(c*Cos[e+f*x])^p*(a+b*Sin[e+f*x])^(m+1)*(a*(m+1)-b*(m+p+2)*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,p},x] && NonzeroQ[a^2-b^2] && RationalQ[m] && m<-1 && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  b*(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m+1)/(c*f*(a^2-b^2)*(m+1)) + 
  1/((a^2-b^2)*(m+1))*Int[(c*Sin[e+f*x])^p*(a+b*Cos[e+f*x])^(m+1)*(a*(m+1)-b*(m+p+2)*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,p},x] && NonzeroQ[a^2-b^2] && RationalQ[m] && m<-1 && IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)*(a+b*Sin[e+f*x])^(m+1)/(b*f*(m+p)) + 
  c^2*(p-1)/(b*(m+p))*Int[(c*Cos[e+f*x])^(p-2)*(a+b*Sin[e+f*x])^m*(b+a*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m},x] && NonzeroQ[a^2-b^2] && RationalQ[p] && p>1 && NonzeroQ[m+p] && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)*(a+b*Cos[e+f*x])^(m+1)/(b*f*(m+p)) + 
  c^2*(p-1)/(b*(m+p))*Int[(c*Sin[e+f*x])^(p-2)*(a+b*Cos[e+f*x])^m*(b+a*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m},x] && NonzeroQ[a^2-b^2] && RationalQ[p] && p>1 && NonzeroQ[m+p] && IntegersQ[2*m,2*p]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  (c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m+1)*(b-a*Sin[e+f*x])/(c*f*(a^2-b^2)*(p+1)) + 
  1/(c^2*(a^2-b^2)*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^m*(a^2*(p+2)-b^2*(m+p+2)+a*b*(m+p+3)*Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m},x] && NonzeroQ[a^2-b^2] && RationalQ[p] && p<-1 && IntegersQ[2*m,2*p]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m+1)*(b-a*Cos[e+f*x])/(c*f*(a^2-b^2)*(p+1)) + 
  1/(c^2*(a^2-b^2)*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^m*(a^2*(p+2)-b^2*(m+p+2)+a*b*(m+p+3)*Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m},x] && NonzeroQ[a^2-b^2] && RationalQ[p] && p<-1 && IntegersQ[2*m,2*p]


Int[Sqrt[c_.*cos[e_.+f_.*x_]]/(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  ArcTan[Rt[b/c,2]*Sqrt[c*Cos[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[b/c,2]*Rt[-a^2+b^2,4]) - 
  ArcTanh[Rt[b/c,2]*Sqrt[c*Cos[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[b/c,2]*Rt[-a^2+b^2,4]) + 
  a*Rt[c,2]*Rt[-b^2/(a^2-b^2),2]*Sqrt[Sin[e+f*x]^2]/(b^2*f*Sin[e+f*x])*
    (EllipticPi[-Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Cos[e+f*x]]/Rt[c,2]],-1] - 
     EllipticPi[Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Cos[e+f*x]]/Rt[c,2]],-1]) /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[c_.*sin[e_.+f_.*x_]]/(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  -ArcTan[Rt[b/c,2]*Sqrt[c*Sin[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[b/c,2]*Rt[-a^2+b^2,4]) + 
  ArcTanh[Rt[b/c,2]*Sqrt[c*Sin[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[b/c,2]*Rt[-a^2+b^2,4]) - 
  a*Rt[c,2]*Rt[-b^2/(a^2-b^2),2]*Sqrt[Cos[e+f*x]^2]/(b^2*f*Cos[e+f*x])*
    (EllipticPi[-Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Sin[e+f*x]]/Rt[c,2]],-1] - 
     EllipticPi[Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Sin[e+f*x]]/Rt[c,2]],-1]) /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[1/(Sqrt[c_.*cos[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  -Rt[b/c,2]*ArcTan[Rt[b/c,2]*Sqrt[c*Cos[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[-a^2+b^2,4]^3) - 
  Rt[b/c,2]*ArcTanh[Rt[b/c,2]*Sqrt[c*Cos[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[-a^2+b^2,4]^3) + 
  a*Sqrt[Sin[e+f*x]^2]/(f*Rt[c,2]*(a^2-b^2)*Sin[e+f*x])*
    (EllipticPi[-Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Cos[e+f*x]]/Rt[c,2]],-1] + 
     EllipticPi[Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Cos[e+f*x]]/Rt[c,2]],-1]) /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[1/(Sqrt[c_.*sin[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  Rt[b/c,2]*ArcTan[Rt[b/c,2]*Sqrt[c*Sin[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[-a^2+b^2,4]^3) + 
  Rt[b/c,2]*ArcTanh[Rt[b/c,2]*Sqrt[c*Sin[e+f*x]]/Rt[-a^2+b^2,4]]/(f*Rt[-a^2+b^2,4]^3) - 
  a*Sqrt[Cos[e+f*x]^2]/(f*Rt[c,2]*(a^2-b^2)*Cos[e+f*x])*
    (EllipticPi[-Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Sin[e+f*x]]/Rt[c,2]],-1] + 
     EllipticPi[Rt[-b^2/(a^2-b^2),2],-ArcSin[Sqrt[c*Sin[e+f*x]]/Rt[c,2]],-1]) /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[1/(Sqrt[c_.*cos[e_.+f_.*x_]]*Sqrt[a_+b_.*sin[e_.+f_.*x_]]),x_Symbol] :=
  2*Sqrt[2]*Sqrt[c*Cos[e+f*x]]*Sqrt[(a+b*Sin[e+f*x])/((a-b)*(1-Sin[e+f*x]))]/
   (c*f*Sqrt[a+b*Sin[e+f*x]]*Sqrt[(1+Cos[e+f*x]+Sin[e+f*x])/(1+Cos[e+f*x]-Sin[e+f*x])])*
   Subst[Int[1/Sqrt[1+(a+b)*x^4/(a-b)],x],x,Sqrt[(1+Cos[e+f*x]+Sin[e+f*x])/(1+Cos[e+f*x]-Sin[e+f*x])]] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[1/(Sqrt[c_.*sin[e_.+f_.*x_]]*Sqrt[a_+b_.*cos[e_.+f_.*x_]]),x_Symbol] :=
  -2*Sqrt[2]*Sqrt[c*Sin[e+f*x]]*Sqrt[(a+b*Cos[e+f*x])/((a-b)*(1-Cos[e+f*x]))]/
   (c*f*Sqrt[a+b*Cos[e+f*x]]*Sqrt[(1+Sin[e+f*x]+Cos[e+f*x])/(1+Sin[e+f*x]-Cos[e+f*x])])*
   Subst[Int[1/Sqrt[1+(a+b)*x^4/(a-b)],x],x,Sqrt[(1+Sin[e+f*x]+Cos[e+f*x])/(1+Sin[e+f*x]-Cos[e+f*x])]] /;
FreeQ[{a,b,c,e,f},x] && NonzeroQ[a^2-b^2]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)*(1-Sin[e+f*x])*(a+b*Sin[e+f*x])^(m+1)*(-(a-b)*(1-Sin[e+f*x])/((a+b)*(1+Sin[e+f*x])))^(m/2)/
    (f*(a+b)*(m+1))*
    Hypergeometric2F1[m+1,m/2+1,m+2,2*(a+b*Sin[e+f*x])/((a+b)*(1+Sin[e+f*x]))] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && ZeroQ[m+p+1]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)*(1-Cos[e+f*x])*(a+b*Cos[e+f*x])^(m+1)*(-(a-b)*(1-Cos[e+f*x])/((a+b)*(1+Cos[e+f*x])))^(m/2)/
    (f*(a+b)*(m+1))*
...
Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  (c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m+1)/(c*f*(a-b)*(p+1)) + 
  a/(c^2*(a-b))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^m/(1-Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && ZeroQ[m+p+2]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m+1)/(c*f*(a-b)*(p+1)) + 
  a/(c^2*(a-b))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^m/(1-Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && ZeroQ[m+p+2]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  (c*Cos[e+f*x])^(p+1)*(a+b*Sin[e+f*x])^(m+1)/(c*f*(a-b)*(p+1)) - 
  b*(m+p+2)/(c^2*(a-b)*(p+1))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^m,x] + 
  a/(c^2*(a-b))*Int[(c*Cos[e+f*x])^(p+2)*(a+b*Sin[e+f*x])^m/(1-Sin[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && NegativeIntegerQ[m+p+2]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -(c*Sin[e+f*x])^(p+1)*(a+b*Cos[e+f*x])^(m+1)/(c*f*(a-b)*(p+1)) - 
  b*(m+p+2)/(c^2*(a-b)*(p+1))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^m,x] + 
  a/(c^2*(a-b))*Int[(c*Sin[e+f*x])^(p+2)*(a+b*Cos[e+f*x])^m/(1-Cos[e+f*x]),x] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && NegativeIntegerQ[m+p+2]


Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)*(a+b*Sin[e+f*x])^(m+1)/
...
FreeQ[{a,b,c,e,f,p},x] && NonzeroQ[a^2-b^2] && NegativeIntegerQ[m] && Not[PositiveIntegerQ[m+p+1]]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)*(a+b*Cos[e+f*x])^(m+1)/
...
Int[(c_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_,x_Symbol] :=
  c*(c*Cos[e+f*x])^(p-1)/(f*(1-(a+b*Sin[e+f*x])/(a-b))^((p-1)/2)*(1-(a+b*Sin[e+f*x])/(a+b))^((p-1)/2))*
    Subst[Int[(-b/(a-b)-b*x/(a-b))^((p-1)/2)*(b/(a+b)-b*x/(a+b))^((p-1)/2)*(a+b*x)^m,x],x,Sin[e+f*x]] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && Not[PositiveIntegerQ[m]]


Int[(c_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_,x_Symbol] :=
  -c*(c*Sin[e+f*x])^(p-1)/(f*(1-(a+b*Cos[e+f*x])/(a-b))^((p-1)/2)*(1-(a+b*Cos[e+f*x])/(a+b))^((p-1)/2))*
    Subst[Int[(-b/(a-b)-b*x/(a-b))^((p-1)/2)*(b/(a+b)-b*x/(a+b))^((p-1)/2)*(a+b*x)^m,x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,e,f,m,p},x] && NonzeroQ[a^2-b^2] && Not[PositiveIntegerQ[m]]


Int[(c_.*cos[e_.+f_.*x_]^n_)^p_*(a_+b_.*sin[e_.+f_.*x_])^m_.,x_Symbol] :=
  (c*Cos[e+f*x]^n)^p/(c*Cos[e+f*x])^(n*p)*Int[(c*Cos[e+f*x])^(n*p)*(a+b*Sin[e+f*x])^m,x] /;
FreeQ[{a,b,c,e,f,m,n,p},x] && Not[IntegerQ[p]]


Int[(c_.*sin[e_.+f_.*x_]^n_)^p_*(a_+b_.*cos[e_.+f_.*x_])^m_.,x_Symbol] :=
  (c*Sin[e+f*x]^n)^p/(c*Sin[e+f*x])^(n*p)*Int[(c*Sin[e+f*x])^(n*p)*(a+b*Cos[e+f*x])^m,x] /;
FreeQ[{a,b,c,e,f,m,n,p},x] && Not[IntegerQ[p]]
...
FreeQ[{a,b,c,d,e,f,m},x] && NonzeroQ[b*c-a*d] && NonzeroQ[a^2-b^2] && ZeroQ[c^2-d^2] && Not[IntegerQ[2*m]]
...
Int[cos[e_.+f_.*x_]^p_*(a_.+b_.*sin[e_.+f_.*x_])^m_.*(c_+d_.*sin[e_.+f_.*x_]),x_Symbol] :=
  c*Cos[e+f*x]/(f*Sqrt[1+Sin[e+f*x]]*Sqrt[1-Sin[e+f*x]])*
    Subst[Int[(1+d/c*x)^(p/2+1/2)*(1-d/c*x)^(p/2-1/2)*(a+b*x)^m,x],x,Sin[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,m},x] && NonzeroQ[a^2-b^2] && ZeroQ[c^2-d^2] && IntegerQ[p/2]


Int[sin[e_.+f_.*x_]^p_*(a_.+b_.*cos[e_.+f_.*x_])^m_.*(c_+d_.*cos[e_.+f_.*x_]),x_Symbol] :=
  -c*Sin[e+f*x]/(f*Sqrt[1+Cos[e+f*x]]*Sqrt[1-Cos[e+f*x]])*
    Subst[Int[(1+d/c*x)^(p/2+1/2)*(1-d/c*x)^(p/2-1/2)*(a+b*x)^m,x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,m},x] && NonzeroQ[a^2-b^2] && ZeroQ[c^2-d^2] && IntegerQ[p/2]
...
Int[(g_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*sin[e_.+f_.*x_]^2,x_Symbol] :=
...
Int[(g_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*cos[e_.+f_.*x_]^2,x_Symbol] :=
...
Int[cos[e_.+f_.*x_]^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*(d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  1/a^p*Int[ExpandTrig[(a-b*sin[e+f*x])^(p/2)*(a+b*sin[e+f*x])^(m+p/2)*(d*sin[e+f*x])^n,x],x] /;
...
Int[sin[e_.+f_.*x_]^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  1/a^p*Int[ExpandTrig[(a-b*cos[e+f*x])^(p/2)*(a+b*cos[e+f*x])^(m+p/2)*(d*cos[e+f*x])^n,x],x] /;
FreeQ[{a,b,d,e,f},x] && ZeroQ[a^2-b^2] && IntegersQ[m,n,p/2] && (m>0 && p>0 && -m-p<n<-1 || m>2 && p<0 && m+p/2>0)


Int[(g_.*cos[e_.+f_.*x_])^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*(d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  Int[ExpandTrig[(g*cos[e+f*x])^p,(a+b*sin[e+f*x])^m*(d*sin[e+f*x])^n,x],x] /;
FreeQ[{a,b,d,e,f,g,n,p},x] && ZeroQ[a^2-b^2] && PositiveIntegerQ[m]


Int[(g_.*sin[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  Int[ExpandTrig[(g*sin[e+f*x])^p,(a+b*cos[e+f*x])^m*(d*cos[e+f*x])^n,x],x] /;
FreeQ[{a,b,d,e,f,g,n,p},x] && ZeroQ[a^2-b^2] && PositiveIntegerQ[m]


Int[cos[e_.+f_.*x_]^2*(a_+b_.*sin[e_.+f_.*x_])^m_*(d_.*sin[e_.+f_.*x_])^n_,x_Symbol] :=
  1/b^2*Int[(a+b*Sin[e+f*x])^(m+1)*(d*Sin[e+f*x])^n*(a-b*Sin[e+f*x]),x] /;
FreeQ[{a,b,d,e,f,m,n},x] && ZeroQ[a^2-b^2] && (NegativeIntegerQ[m] || Not[PositiveIntegerQ[n]])


Int[sin[e_.+f_.*x_]^2*(a_+b_.*cos[e_.+f_.*x_])^m_*(d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  1/b^2*Int[(a+b*Cos[e+f*x])^(m+1)*(d*Cos[e+f*x])^n*(a-b*Cos[e+f*x]),x] /;
FreeQ[{a,b,d,e,f,m,n},x] && ZeroQ[a^2-b^2] && (NegativeIntegerQ[m] || Not[PositiveIntegerQ[n]])
...
Int[cos[e_.+f_.*x_]^p_*(a_+b_.*sin[e_.+f_.*x_])^m_.*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  a^m*Cos[e+f*x]/(f*Sqrt[1+Sin[e+f*x]]*Sqrt[1-Sin[e+f*x]])*
    Subst[Int[(1+b/a*x)^(m+p/2-1/2)*(1-b/a*x)^(p/2-1/2)*(c+d*x)^n,x],x,Sin[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,n},x] && ZeroQ[a^2-b^2] && IntegerQ[p/2] && IntegerQ[m]


Int[sin[e_.+f_.*x_]^p_*(a_+b_.*cos[e_.+f_.*x_])^m_.*(c_.+d_.*cos[e_.+f_.*x_])^n_.,x_Symbol] :=
  -a^m*Sin[e+f*x]/(f*Sqrt[1+Cos[e+f*x]]*Sqrt[1-Cos[e+f*x]])*
    Subst[Int[(1+b/a*x)^(m+p/2-1/2)*(1-b/a*x)^(p/2-1/2)*(c+d*x)^n,x],x,Cos[e+f*x]] /;
FreeQ[{a,b,c,d,e,f,n},x] && ZeroQ[a^2-b^2] && IntegerQ[p/2] && IntegerQ[m]
...
FreeQ[{a,b,d,e,f},x] && NonzeroQ[a^2-b^2] && RationalQ[n,m] && m<-1 && n<-1 && (PositiveIntegerQ[m] || IntegersQ[2*m,2*n]) *)
...
FreeQ[{a,b,d,e,f,n},x] && NonzeroQ[a^2-b^2] && RationalQ[m] && m<-1 && Not[RationalQ[n] && n<-1] && (m<-2 || ZeroQ[m+n+4]) && 
  (PositiveIntegerQ[m] || IntegersQ[2*m,2*n])
...
FreeQ[{a,b,d,e,f,n,m},x] && NonzeroQ[a^2-b^2] && Not[RationalQ[m] && m<-1] && Not[RationalQ[n] && n<-1] && 
  NonzeroQ[m+n+3] && NonzeroQ[m+n+4] && (PositiveIntegerQ[m] || IntegersQ[2*m,2*n])
...
FreeQ[{a,b,d,e,f,m,n},x] && NonzeroQ[a^2-b^2] && NonzeroQ[n+1] && NonzeroQ[n+2] && NonzeroQ[m+n+5] && NonzeroQ[m+n+6] && 
  Not[PositiveIntegerQ[m]] && (PositiveIntegerQ[m] || IntegersQ[2*m,2*n])
...
Int[Sqrt[g_.*cos[e_.+f_.*x_]]*Sqrt[d_.*sin[e_.+f_.*x_]]/(a_+b_.*sin[e_.+f_.*x_]),x_Symbol] :=
  d/b*Int[Sqrt[g*Cos[e+f*x]]/Sqrt[d*Sin[e+f*x]],x] - 
  a*d/b*Int[Sqrt[g*Cos[e+f*x]]/(Sqrt[d*Sin[e+f*x]]*(a+b*Sin[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[g_.*sin[e_.+f_.*x_]]*Sqrt[d_.*cos[e_.+f_.*x_]]/(a_+b_.*cos[e_.+f_.*x_]),x_Symbol] :=
  d/b*Int[Sqrt[g*Sin[e+f*x]]/Sqrt[d*Cos[e+f*x]],x] - 
  a*d/b*Int[Sqrt[g*Sin[e+f*x]]/(Sqrt[d*Cos[e+f*x]]*(a+b*Cos[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]
...
Int[Sqrt[cos[e_.+f_.*x_]]/(Sqrt[sin[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  2*Sqrt[2]*EllipticPi[Sqrt[-a+b]/Sqrt[a+b],-ArcSin[Sqrt[Cos[e+f*x]]/Sqrt[1+Sin[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) - 
  2*Sqrt[2]*EllipticPi[-Sqrt[-a+b]/Sqrt[a+b],-ArcSin[Sqrt[Cos[e+f*x]]/Sqrt[1+Sin[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) /;
FreeQ[{a,b,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[sin[e_.+f_.*x_]]/(Sqrt[cos[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  2*Sqrt[2]*EllipticPi[-Sqrt[-a+b]/Sqrt[a+b],-ArcSin[Sqrt[Sin[e+f*x]]/Sqrt[1+Cos[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) - 
  2*Sqrt[2]*EllipticPi[Sqrt[-a+b]/Sqrt[a+b],-ArcSin[Sqrt[Sin[e+f*x]]/Sqrt[1+Cos[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) /;
FreeQ[{a,b,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[g_.*cos[e_.+f_.*x_]]/(Sqrt[d_.*sin[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  Sqrt[g*Cos[e+f*x]]*Sqrt[Sin[e+f*x]]/(Sqrt[Cos[e+f*x]]*Sqrt[d*Sin[e+f*x]])*
    Int[Sqrt[Cos[e+f*x]]/(Sqrt[Sin[e+f*x]]*(a+b*Sin[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[g_.*sin[e_.+f_.*x_]]/(Sqrt[d_.*cos[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  Sqrt[g*Sin[e+f*x]]*Sqrt[Cos[e+f*x]]/(Sqrt[Sin[e+f*x]]*Sqrt[d*Cos[e+f*x]])*
    Int[Sqrt[Sin[e+f*x]]/(Sqrt[Cos[e+f*x]]*(a+b*Cos[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]
...
Int[Sqrt[sin[e_.+f_.*x_]]/(Sqrt[cos[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  2*Sqrt[2]*EllipticPi[a/(-b+Sqrt[-a+b]*Sqrt[a+b]),-ArcSin[Sqrt[Sin[e+f*x]]/Sqrt[1+Cos[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) - 
  2*Sqrt[2]*EllipticPi[-a/(b+Sqrt[-a+b]*Sqrt[a+b]),-ArcSin[Sqrt[Sin[e+f*x]]/Sqrt[1+Cos[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) /;
FreeQ[{a,b,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[cos[e_.+f_.*x_]]/(Sqrt[sin[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  2*Sqrt[2]*EllipticPi[-a/(b+Sqrt[-a+b]*Sqrt[a+b]),-ArcSin[Sqrt[Cos[e+f*x]]/Sqrt[1+Sin[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) - 
  2*Sqrt[2]*EllipticPi[a/(-b+Sqrt[-a+b]*Sqrt[a+b]),-ArcSin[Sqrt[Cos[e+f*x]]/Sqrt[1+Sin[e+f*x]]],-1]/(f*Sqrt[-a+b]*Sqrt[a+b]) /;
FreeQ[{a,b,e,f},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[d_.*sin[e_.+f_.*x_]]/(Sqrt[g_.*cos[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  Sqrt[Cos[e+f*x]]*Sqrt[d*Sin[e+f*x]]/(Sqrt[g*Cos[e+f*x]]*Sqrt[Sin[e+f*x]])*
    Int[Sqrt[Sin[e+f*x]]/(Sqrt[Cos[e+f*x]]*(a+b*Sin[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]


Int[Sqrt[d_.*cos[e_.+f_.*x_]]/(Sqrt[g_.*sin[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  Sqrt[Sin[e+f*x]]*Sqrt[d*Cos[e+f*x]]/(Sqrt[g*Sin[e+f*x]]*Sqrt[Cos[e+f*x]])*
    Int[Sqrt[Cos[e+f*x]]/(Sqrt[Sin[e+f*x]]*(a+b*Cos[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]
...
Int[1/(Sqrt[g_.*cos[e_.+f_.*x_]]*Sqrt[d_.*sin[e_.+f_.*x_]]*(a_+b_.*sin[e_.+f_.*x_])),x_Symbol] :=
  1/a*Int[1/(Sqrt[g*Cos[e+f*x]]*Sqrt[d*Sin[e+f*x]]),x] - 
  b/(a*d)*Int[Sqrt[d*Sin[e+f*x]]/(Sqrt[g*Cos[e+f*x]]*(a+b*Sin[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]


Int[1/(Sqrt[g_.*sin[e_.+f_.*x_]]*Sqrt[d_.*cos[e_.+f_.*x_]]*(a_+b_.*cos[e_.+f_.*x_])),x_Symbol] :=
  1/a*Int[1/(Sqrt[g*Sin[e+f*x]]*Sqrt[d*Cos[e+f*x]]),x] - 
  b/(a*d)*Int[Sqrt[d*Cos[e+f*x]]/(Sqrt[g*Sin[e+f*x]]*(a+b*Cos[e+f*x])),x] /;
FreeQ[{a,b,d,e,f,g},x] && NonzeroQ[a^2-b^2]


Int[cos[e_.+f_.*x_]^p_*(a_+b_.*sin[e_.+f_.*x_])^m_*(c_.+d_.*sin[e_.+f_.*x_])^n_.,x_Symbol] :=
  Int[ExpandTrig[(a+b*sin[e+f*x])^m*(c+d*sin[e+f*x])^n*(1-sin[e+f*x]^2)^(p/2),x],x] /;
FreeQ[{a,b,c,d,e,f,m,n},x] && NonzeroQ[a^2-b^2] && IntegersQ[p/2] && (IntegerQ[m] && m<-1 || p>0) && IntegersQ[2*m,2*n]
...
Int[(g_.*cos[e_.+f_.*x_])^p_*(a_+b_.*cos[e_.+f_.*x_])^m_*(c_+d_.*cos[e_.+f_.*x_])^n_,x_Symbol] :=
  Defer[Int][(g*Cos[e+f*x])^p*(a+b*Cos[e+f*x])^m*(c+d*Cos[e+f*x])^n,x] /;
FreeQ[{a,b,c,d,e,f,g,m,n,p},x] && NonzeroQ[p-2]
...
FreeQ[{a,b,c,d,e,f,A,B},x] && NonzeroQ[b*c-a*d] && NonzeroQ[a^2-b^2] && RationalQ[m] && m<-1 && (IntegerQ[2*m] || ZeroQ[a])
...
Int[(a_.+b_.*sin[e_.+f_.*x_])^m_.*(c_.+d_.*sin[e_.+f_.*x_])*(A_+B_.*sin[e_.+f_.*x_]),x_Symbol] :=
  -B*d*Cos[e+f*x]*(a+b*Sin[e+f*x])^(m+1)/(b*f*(m+2)) + 
  1/(b*(m+2))*Int[(a+b*Sin[e+f*x])^m*Simp[b*(A*c*(m+2)+B*d*(m+1))+(A*b*d*(m+2)-B*(a*d-b*c*(m+2)))*Sin[e+f*x],x],x] /;
FreeQ[{a,b,c,d,e,f,A,B,m},x] && NonzeroQ[b*c-a*d] && NonzeroQ[a^2-b^2] && Not[RationalQ[m] && m<-1] && 
  Not[ZeroQ[c] && EqQ[m,1]] && (IntegerQ[2*m] || ZeroQ[a])
